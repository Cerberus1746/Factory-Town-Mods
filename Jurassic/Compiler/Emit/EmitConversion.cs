...
namespace Jurassic.Compiler
{
    ...
    internal static class EmitConversion
    {
        ...
        public static void Convert(ILGenerator generator, PrimitiveType fromType, PrimitiveType toType) => Convert(generator, fromType, toType, null, null, 0);
        ...
        public static void Convert(ILGenerator generator, PrimitiveType fromType, PrimitiveType toType, OptimizationInfo optimizationInfo) => Convert(generator, fromType, toType, optimizationInfo.Source.Path, optimizationInfo.FunctionName, optimizationInfo.SourceSpan.StartLine);
        ...
        public static void ToBool(ILGenerator generator, PrimitiveType fromType)
        {
            ...
            switch (fromType)
            {
                ...
                case PrimitiveType.Number:
                    ...
                    ILLocalVariable temp = generator.CreateTemporaryVariable(fromType);
        ...
        public static void ToInteger(ILGenerator generator, PrimitiveType fromType)
        {
            ...
            switch (fromType)
            {
                ...
                case PrimitiveType.Number:
                    ...
                    ILLocalVariable isPositiveInfinity = generator.CreateTemporaryVariable(typeof(bool));
                    generator.Duplicate();
                    ...
                    ILLocalVariable notNaN = generator.CreateTemporaryVariable(typeof(bool));
                    generator.Duplicate();
                    generator.Duplicate();
                    generator.CompareEqual();
        ...
        /// <param name="generator"> The IL generator. </param>
        /// <param name="fromType"> The type to convert from. </param>
        public static void ToUInt32(ILGenerator generator, PrimitiveType fromType) => ToInt32(generator, fromType);
        ...
        public static void ToString(ILGenerator generator, PrimitiveType fromType)
        {
            ...
            switch (fromType)
            {
                ...
                case PrimitiveType.Bool:
                    ...
                    ILLabel elseClause = generator.CreateLabel();
                    ILLabel endOfIf = generator.CreateLabel();
        ...
        /// <param name="fromType"> The type to convert from. </param>
        /// <param name="optimizationInfo"> Information about the line number, function and path. </param>
        public static void ToObject(ILGenerator generator, PrimitiveType fromType, OptimizationInfo optimizationInfo) => ToObject(generator, fromType, optimizationInfo.Source.Path, optimizationInfo.FunctionName, optimizationInfo.SourceSpan.StartLine);
        ...
        public static void ToObject(ILGenerator generator, PrimitiveType fromType, string path, string function, int line)
        {
            ...
            switch (fromType)
            {
                ...
                case PrimitiveType.Any:
                    ...
                    ToAny(generator, fromType);
                    ILLocalVariable temp = generator.CreateTemporaryVariable(typeof(object));
                    generator.StoreVariable(temp);
