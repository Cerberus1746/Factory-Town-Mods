...
namespace Jurassic.Compiler
{
    ...
    internal abstract class ILGenerator
    {
        ...
        {
            ILLabel label = this.CreateLabel();
            this.DefineLabelPosition(label);
            return label;
        }
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public void BranchIfFalse(ILLabel label) => this.BranchIfZero(label);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public void BranchIfTrue(ILLabel label) => this.BranchIfNotZero(label);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public void BranchIfNull(ILLabel label) => this.BranchIfZero(label);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public void BranchIfNotNull(ILLabel label) => this.BranchIfNotZero(label);
        ...
        /// <param name="name"> The name of the local variable. Can be <c>null</c>. </param>
        /// <returns> A new local variable. </returns>
        public ILLocalVariable DeclareVariable(PrimitiveType type, string name = null) => this.DeclareVariable(PrimitiveTypeUtilities.ToType(type), name);
        ...
        public ILLocalVariable CreateTemporaryVariable(Type type)
        {
            ...
            if (this.temporaryVariables != null)
            {
                for (int i = 0; i < this.temporaryVariables.Count; i++)
                {
                    ...
                    {
                        ILLocalVariable result = this.temporaryVariables[i];
            ...
            return this.DeclareVariable(type);
        }
        ...
        /// <param name="type"> The type of variable to create. </param>
        /// <returns> A temporary variable  </returns>
        public ILLocalVariable CreateTemporaryVariable(PrimitiveType type) => this.CreateTemporaryVariable(PrimitiveTypeUtilities.ToType(type));
        ...
        public void LoadBoolean(bool value) => this.LoadInt32(value ? 1 : 0);
        ...
        /// </summary>
        /// <param name="value"> The integer to push onto the stack. </param>
        public void LoadInt32(uint value) => this.LoadInt32((int) value);
        ...
        /// </summary>
        /// <param name="value"> The 64-bit integer to push onto the stack. </param>
        public void LoadInt64(ulong value) => this.LoadInt64((long) value);
        ...
        /// </summary>
        /// <param name="type"> The type of value to box.  This should be a value type. </param>
        public void Box(PrimitiveType type) => this.Box(PrimitiveTypeUtilities.ToType(type));
        ...
        /// </summary>
        /// <param name="type"> The type of the boxed value.  This should be a value type. </param>
        public void Unbox(PrimitiveType type) => this.Unbox(PrimitiveTypeUtilities.ToType(type));
        ...
        /// </summary>
        /// <param name="type"> The type of the boxed value.  This should be a value type. </param>
        public void UnboxAny(PrimitiveType type) => this.UnboxAny(PrimitiveTypeUtilities.ToType(type));
        ...
        public void Call(System.Reflection.MethodBase method)
        {
            if (method.IsStatic == true || method.DeclaringType.IsValueType == true) {
                this.CallStatic(method);
            } else {
                this.CallVirtual(method);
            }
        }
        ...
        public void LoadMethodPointer(System.Reflection.MethodBase method)
        {
            ...
            if (method.IsStatic == true || method.DeclaringType.IsValueType == true) {
                this.LoadStaticMethodPointer(method);
            } else {
                this.LoadVirtualMethodPointer(method);
            }
        }
        ...
        /// </summary>
        /// <param name="type"> The element type. </param>
        public void LoadArrayElement(PrimitiveType type) => this.LoadArrayElement(PrimitiveTypeUtilities.ToType(type));
        ...
        /// </summary>
        /// <param name="type"> The element type. </param>
        public void StoreArrayElement(PrimitiveType type) => this.StoreArrayElement(PrimitiveTypeUtilities.ToType(type));
        ...
        /// </summary>
        public void EndFault() => this.EndFinally();
        ...
        public void MarkSequencePoint(System.Diagnostics.SymbolStore.ISymbolDocumentWriter document, SourceCodeSpan span)
        {
            ...
            this.MarkSequencePoint(document, span.StartLine, span.StartColumn, span.EndLine, span.EndColumn);
        }
