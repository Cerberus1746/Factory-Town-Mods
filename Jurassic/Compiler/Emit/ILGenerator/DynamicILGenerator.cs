...
#pragma warning restore 0649
        ...
        public override unsafe void Complete()
        {
            ...
            if (this.exceptionRegions != null && this.exceptionRegions.Count > 0)
            {
                ...
                int clauseCount = 0;
                foreach (ExceptionRegion exceptionRegion in this.exceptionRegions) {
                    clauseCount += exceptionRegion.Clauses.Count;
                }

                byte[] exceptionBytes = new byte[4 + 24 * clauseCount];
                System.IO.BinaryWriter writer = new System.IO.BinaryWriter(new System.IO.MemoryStream(exceptionBytes));
                ...
                foreach (ExceptionRegion exceptionRegion in this.exceptionRegions)
                {
                    foreach (ExceptionClause clause in exceptionRegion.Clauses)
                    {
                        switch (clause.Type)
                        {
        ...
        private void EnlargeArray(int instructionSize) => Array.Resize(ref this.bytes, this.bytes.Length * 2);
        ...
        private void Emit1ByteOpCode(byte opCode, int popCount, int pushCount)
        {
            ...
            if (this.offset + instructionSize >= this.bytes.Length) {
                this.EnlargeArray(instructionSize);
            }
        ...
        /// <returns> A metadata token. </returns>
        private int GetToken(Type type) => this.dynamicILInfo.GetTokenFor(type.TypeHandle);
        ...
        /// <returns> A metadata token. </returns>
        private int GetToken(System.Reflection.FieldInfo field) => this.dynamicILInfo.GetTokenFor(field.FieldHandle);
        ...
        /// <returns> A metadata token. </returns>
        private int GetToken(string str) => this.dynamicILInfo.GetTokenFor(str);
        ...
        {
            this.Emit1ByteOpCode(0x26, 1, 0);
            this.PopStackOperands(VESType.Int32 | VESType.Int64 | VESType.Float | VESType.NativeInt | VESType.Object | VESType.ManagedPointer);
        }
        ...
        {
            this.Emit1ByteOpCode(0x25, 1, 2);
#if DEBUG
            this.PushStackOperand(this.operands.Peek());
#endif
        }
        ...
        /// </summary>
        private void ClearEvaluationStack() => this.ReplaceEvaluationStack();
...
#if DEBUG
            this.operands.Clear();
            foreach (VESType operandType in operandTypes) {
        ...
        private void CheckArithmeticOperands(ArithmeticOperator @operator)
        {
            ...
            VESType right = this.operands.Pop();
            VESType left = this.operands.Pop();
            ...
            switch (left)
            {
                ...
                case VESType.Int64:
                    ...
                    this.PushStackOperand(VESType.Int64);
                    break;
                ...
                case VESType.NativeInt:
                    ...
                    this.PushStackOperand(right == VESType.ManagedPointer ? VESType.ManagedPointer : VESType.NativeInt);
                    break;
                ...
                case VESType.Float:
                    ...
                    this.PushStackOperand(VESType.Float);
                    break;
                ...
                case VESType.ManagedPointer:
                    ...
                    this.PushStackOperand(right == VESType.ManagedPointer ? VESType.NativeInt : VESType.ManagedPointer);
                    break;
        ...
        private void CheckComparisonOperands(ComparisonOperator @operator, bool branchOperation)
        {
            ...
            if (branchOperation == false)
            {
                ...
                this.PushStackOperand(VESType.Int32);
            }
        }
        ...
        {
            DynamicILLabel result = new DynamicILLabel(this, this.labels.Count);
        ...
        public override void DefineLabelPosition(ILLabel label)
        {
            ...
            DynamicILLabel label2 = (DynamicILLabel)label;
            ...
            {
                VESType[] previousStack = (VESType[])label2.EvaluationStack;
                if (this.stackIsIndeterminate == false)
                {
                    // Check the evaluation stack matches that in the label.
                    VESType[] currentStack = this.operands.ToArray();
        ...
        {
            foreach (Fixup fix in this.fixups)
            {
        ...
        private void BranchCore(ILLabel label, byte opCode)
        {
            ...
            this.Emit1ByteOpCode(opCode, 0, 0);

            // Emit the label.
            this.EmitLabel(label, this.offset + 4);
        ...
        {
            // Emit the branch opcode.
            this.Emit1ByteOpCode(opCode, 1, 0);

            // The instruction pops one value from the stack and pushes none.
            this.PopStackOperands(operandType);
        ...
        {
            // Emit the branch opcode.
            this.Emit1ByteOpCode(opCode, 2, 0);

            // The instruction pops two values from the stack and pushes none.
            this.CheckComparisonOperands(@operator, branchOperation: true);
        ...
        private void EmitLabel(ILLabel label, int startOfNextInstruction)
        {
            ...
            if (label2.ILOffset >= 0)
            {
                ...
                this.EmitInt32(label2.ILOffset - startOfNextInstruction);
            }
            else
            {
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void Branch(ILLabel label) => this.BranchCore(label, 0x38);

        /// <summary>
        /// Branches to the given label if the value on the top of the stack is zero.
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfZero(ILLabel label) => this.BranchCore(label, 0x39, VESType.Int32 | VESType.Int64 | VESType.Float |
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfNotZero(ILLabel label) => this.BranchCore(label, 0x3A, VESType.Int32 | VESType.Int64 | VESType.Float |
                VESType.ManagedPointer | VESType.NativeInt | VESType.Object);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfEqual(ILLabel label) => this.BranchCore(label, 0x3B, ComparisonOperator.Equal);

        /// <summary>
        /// Branches to the given label if the two values on the top of the stack are not equal.
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfNotEqual(ILLabel label) => this.BranchCore(label, 0x40, ComparisonOperator.NotEqual);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfGreaterThan(ILLabel label) => this.BranchCore(label, 0x3D, ComparisonOperator.GreaterThan);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfGreaterThanUnsigned(ILLabel label) => this.BranchCore(label, 0x42, ComparisonOperator.GreaterThanUnsigned);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfGreaterThanOrEqual(ILLabel label) => this.BranchCore(label, 0x3C, ComparisonOperator.GreaterThanOrEqual);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfGreaterThanOrEqualUnsigned(ILLabel label) => this.BranchCore(label, 0x41, ComparisonOperator.GreaterThanOrEqual);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfLessThan(ILLabel label) => this.BranchCore(label, 0x3F, ComparisonOperator.LessThan);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfLessThanUnsigned(ILLabel label) => this.BranchCore(label, 0x44, ComparisonOperator.LessThanUnsigned);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfLessThanOrEqual(ILLabel label) => this.BranchCore(label, 0x3E, ComparisonOperator.LessThanOrEqual);
        ...
        /// </summary>
        /// <param name="label"> The label to branch to. </param>
        public override void BranchIfLessThanOrEqualUnsigned(ILLabel label) => this.BranchCore(label, 0x3E, ComparisonOperator.LessThanOrEqualUnsigned);
        ...
        public override void Return()
        {
            ...
            // ret = 2A
            this.Emit1ByteOpCode(0x2A, popCount, 0);

            if (this.stackIsIndeterminate == false)
            {
                // The instruction might pop a value from the stack.
                if (popCount > 0) {
                    this.PopStackOperands(ToVESType(this.dynamicMethod.ReturnType));
                }
        ...
        public override void Switch(ILLabel[] labels)
        {
            ...
            // switch = 45
            this.Emit1ByteOpCode(0x45, 1, 0);

            // Emit the number of labels.
            this.EmitInt32(labels.Length);

            // Emit the labels.
            foreach (ILLabel label in labels) {
                this.EmitLabel(label, startOfNextInstruction);
            }
        }
        ...
        {
            DynamicILLocalVariable result = new DynamicILLocalVariable(this, this.localVariables.Count, type, name);
        ...
        public override void LoadVariable(ILLocalVariable variable)
        {
            ...
            if (variable.Index <= 3)
            {
                ...
                // ldloc.2 = 08
                // ldloc.3 = 09
                this.Emit1ByteOpCode((byte)(0x06 + variable.Index), 0, 1);
            }
            else if (variable.Index < 256)
            {
                // ldloc.s index = 11 <unsigned int8>
                this.Emit1ByteOpCodeInt8(0x11, 0, 1, variable.Index);
            }
            else if (variable.Index < 65535)
            {
                // ldloc index = FE 0C <unsigned int16>
                this.Emit2ByteOpCodeInt16(0xFE, 0x0C, 0, 1, variable.Index);
            }
            else {
                throw new InvalidOperationException("Too many local variables.");
            }

            this.PushStackOperand(ToVESType(variable.Type));
        }
        ...
        public override void LoadAddressOfVariable(ILLocalVariable variable)
        {
            ...
            if (variable.Index < 256)
            {
                ...
                this.Emit1ByteOpCodeInt8(0x12, 0, 1, variable.Index);
            }
            else if (variable.Index < 65535)
            {
                // ldloca index = FE 0D <unsigned int16>
                this.Emit2ByteOpCodeInt16(0xFE, 0x0D, 0, 1, variable.Index);
            }
            else {
                throw new InvalidOperationException("Too many local variables.");
            }

            this.PushStackOperand(VESType.ManagedPointer);
        }
        ...
        public override void StoreVariable(ILLocalVariable variable)
        {
            ...
            if (variable.Index <= 3)
            {
                ...
                // stloc.2 = 0C
                // stloc.3 = 0D
                this.Emit1ByteOpCode((byte)(0x0A + variable.Index), 1, 0);
            }
            else if (variable.Index < 256)
            {
                // stloc.s index = 13 <unsigned int8>
                this.Emit1ByteOpCodeInt8(0x13, 1, 0, variable.Index);
            }
            else if (variable.Index < 65535)
            {
                // stloc index = FE 0E <unsigned int16>
                this.Emit2ByteOpCodeInt16(0xFE, 0x0E, 1, 0, variable.Index);
            }
            else {
                throw new InvalidOperationException("Too many local variables.");
            }

            this.PopStackOperands(ToVESType(variable.Type));
        }
        ...
        public override void LoadArgument(int argumentIndex)
        {
            ...
            if (argumentIndex < 4) {
                this.Emit1ByteOpCode((byte)(argumentIndex + 2), 0, 1);
            } else if (argumentIndex < 256) {
                this.Emit1ByteOpCodeInt8(0x0E, 0, 1, argumentIndex);
            } else {
                this.Emit2ByteOpCodeInt16(0xFE, 0x09, 0, 1, argumentIndex);
            }

            this.PushStackOperand(ToVESType(this.dynamicMethod.GetParameters()[argumentIndex].ParameterType));
        }
        ...
        public override void StoreArgument(int argumentIndex)
        {
            ...
            if (argumentIndex < 256) {
                this.Emit1ByteOpCodeInt8(0x10, 1, 0, argumentIndex);
            } else {
                this.Emit2ByteOpCodeInt16(0xFE, 0x0B, 1, 0, argumentIndex);
            }

            this.PopStackOperands(ToVESType(this.dynamicMethod.GetParameters()[argumentIndex].ParameterType));
        }
        ...
        {
            this.Emit1ByteOpCode(0x14, 0, 1);
            this.PushStackOperand(VESType.Object);
        }
        ...
        public override void LoadInt32(int value)
        {
            if (value >= -1 && value <= 8)
            {
                ...
                // ldc.i4.7 = 1D
                // ldc.i4.8 = 1E
                this.Emit1ByteOpCode((byte)(0x16 + value), 0, 1);
            }
            else if (value >= -128 && value <= 127)
            {
                // ldc.i4.s value = 1F <unsigned int8>
                this.Emit1ByteOpCodeInt8(0x1F, 0, 1, value);
            }
            else
            {
                // ldc.i4 value = 20 <int32>
                this.Emit1ByteOpCodeInt32(0x20, 0, 1, value);
            }
        ...
        public override void LoadInt64(long value)
        {
            ...
            this.Emit1ByteOpCodeInt64(0x21, 0, 1, value);
        ...
        {
            // ldc.r8 = 23 <float64>
            this.Emit1ByteOpCodeInt64(0x23, 0, 1, BitConverter.DoubleToInt64Bits(value));
        ...
        public override void LoadString(string value)
        {
            ...
            // ldstr = 72 <token>
            this.Emit1ByteOpCodeInt32(0x72, 0, 1, token);
        ...
        {
            this.Emit2ByteOpCode(0xFE, 0x01, 2, 1);
            this.CheckComparisonOperands(ComparisonOperator.Equal, branchOperation: false);
        }
        ...
        {
            this.Emit2ByteOpCode(0xFE, 0x02, 2, 1);
            this.CheckComparisonOperands(ComparisonOperator.GreaterThan, branchOperation: false);
        }
        ...
        {
            this.Emit2ByteOpCode(0xFE, 0x03, 2, 1);
            this.CheckComparisonOperands(ComparisonOperator.GreaterThanUnsigned, branchOperation: false);
        }
        ...
        {
            this.Emit2ByteOpCode(0xFE, 0x04, 2, 1);
            this.CheckComparisonOperands(ComparisonOperator.LessThan, branchOperation: false);
        }
        ...
        {
            this.Emit2ByteOpCode(0xFE, 0x05, 2, 1);
            this.CheckComparisonOperands(ComparisonOperator.LessThanUnsigned, branchOperation: false);
        }
        ...
        {
            this.Emit1ByteOpCode(0x58, 2, 1);
            this.CheckArithmeticOperands(ArithmeticOperator.Add);
        }
        ...
        {
            this.Emit1ByteOpCode(0x59, 2, 1);
            this.CheckArithmeticOperands(ArithmeticOperator.Subtract);
        }
        ...
        {
            this.Emit1ByteOpCode(0x5A, 2, 1);
            this.CheckArithmeticOperands(ArithmeticOperator.Multiply);
        }
        ...
        {
            this.Emit1ByteOpCode(0x5B, 2, 1);
            this.CheckArithmeticOperands(ArithmeticOperator.Divide);
        }
        ...
        {
            this.Emit1ByteOpCode(0x5D, 2, 1);
            this.CheckArithmeticOperands(ArithmeticOperator.Remainder);
        }
        ...
        {
            this.Emit1ByteOpCode(0x65, 1, 1);

#if DEBUG
            VESType topOfStack = this.operands.Peek();
            this.PopStackOperands(VESType.Int32 | VESType.Int64 | VESType.NativeInt | VESType.Float);
            this.PushStackOperand(topOfStack);
#endif
        }
        ...
        {
            this.Emit1ByteOpCode(0x5F, 2, 1);
            this.PopStackOperands(VESType.Int32, VESType.Int32);
            this.PushStackOperand(VESType.Int32);
        }
        ...
        {
            this.Emit1ByteOpCode(0x66, 1, 1);
            this.PopStackOperands(VESType.Int32);
            this.PushStackOperand(VESType.Int32);
        }
        ...
        public override void Box(Type type)
        {
            ...
            this.Emit1ByteOpCodeInt32(0x8C, 1, 1, token);
            this.PopStackOperands(VESType.Int32 | VESType.Int64 | VESType.Float | VESType.ManagedPointer | VESType.Object);
            this.PushStackOperand(VESType.Object);
        }
        ...
        public override void Unbox(Type type)
        {
            ...
            // Get the token for the type.
            int token = this.GetToken(type);
            this.Emit1ByteOpCodeInt32(0x79, 1, 1, token);
            this.PopStackOperands(VESType.Object);
            this.PushStackOperand(VESType.ManagedPointer);
        }
        ...
        public override void UnboxAny(Type type)
        {
            ...
            // Get the token for the type.
            int token = this.GetToken(type);
            this.Emit1ByteOpCodeInt32(0xA5, 1, 1, token);
            this.PopStackOperands(VESType.Object);
            this.PushStackOperand(ToVESType(type));
        }
        ...
        {
            this.Emit1ByteOpCode(0x76, 1, 1);
            this.PopStackOperands(VESType.Int32 | VESType.Int64 | VESType.NativeInt);
            this.PushStackOperand(VESType.Float);
        }
        ...
        public override void NewObject(System.Reflection.ConstructorInfo constructor)
        {
            ...
            int token = this.GetToken(constructor);
            this.Emit1ByteOpCodeInt32(0x73, parameters.Length, 1, token);

#if DEBUG
            // Check the stack.
            List<VESType> operandTypes = new List<VESType>(parameters.Length);
            foreach (System.Reflection.ParameterInfo parameter in parameters) {
                operandTypes.Add(ToVESType(parameter.ParameterType));
            }

            this.PopStackOperands(operandTypes.ToArray());
            this.PushStackOperand(ToVESType(constructor.DeclaringType));
#endif
        }
        ...
        private void EmitCall(byte opcode, System.Reflection.MethodBase method)
        {
            ...
            // Call the method.
            this.Emit1ByteOpCodeInt32(opcode, parameters.Length + (method.IsStatic ? 0 : 1), returnType == typeof(void) ? 0 : 1, token);
            ...
            if (returnType != typeof(void)) {
                this.PushStackOperand(ToVESType(returnType));
            }
#endif
        }
        ...
        public override void LoadField(System.Reflection.FieldInfo field)
        {
            ...
            {
                // ldsfld = 7E <token>
                this.Emit1ByteOpCodeInt32(0x7E, 0, 1, token);
            }
            else
            {
                // ldfld = 7B <token>
                this.PopStackOperands(VESType.Object | VESType.ManagedPointer | VESType.NativeInt);
                this.Emit1ByteOpCodeInt32(0x7B, 1, 1, token);
            }
            this.PushStackOperand(ToVESType(field.FieldType));
        }
        ...
        public override void StoreField(System.Reflection.FieldInfo field)
        {
            ...
            {
                // stsfld = 80 <token>
                this.PopStackOperands(ToVESType(field.FieldType));
                this.Emit1ByteOpCodeInt32(0x80, 1, 0, token);
            }
            else
            {
                // stfld = 7D <token>
                this.PopStackOperands(VESType.Object | VESType.ManagedPointer | VESType.NativeInt, ToVESType(field.FieldType));
                this.Emit1ByteOpCodeInt32(0x7D, 2, 0, token);
            }
        }
        ...
        public override void CastClass(Type type)
        {
            ...
            int token = this.GetToken(type);
            this.Emit1ByteOpCodeInt32(0x74, 1, 1, token);
            this.PopStackOperands(VESType.Object);
            this.PushStackOperand(VESType.Object);
        }
        ...
        public override void IsInstance(Type type)
        {
            ...
            int token = this.GetToken(type);
            this.Emit1ByteOpCodeInt32(0x75, 1, 1, token);
            this.PopStackOperands(VESType.Object);
            this.PushStackOperand(VESType.Object);
        }
        ...
        public override void LoadToken(Type type)
        {
            ...
            int token = this.GetToken(type);
            this.Emit1ByteOpCodeInt32(0xD0, 0, 1, token);
            this.PushStackOperand(VESType.ManagedPointer);
        }
        ...
        public override void LoadStaticMethodPointer(System.Reflection.MethodBase method)
        {
            ...
            int token = this.GetToken(method);
            this.Emit2ByteOpCodeInt32(0xFE, 0x06, 0, 1, token);
            this.PushStackOperand(VESType.NativeInt);
        }
        ...
        public override void LoadVirtualMethodPointer(System.Reflection.MethodBase method)
        {
            ...
            int token = this.GetToken(method);
            this.Emit2ByteOpCodeInt32(0xFE, 0x07, 0, 1, token);
            this.PushStackOperand(VESType.NativeInt);
        }
        ...
        public override void InitObject(Type type)
        {
            ...
            int token = this.GetToken(type);
            this.Emit2ByteOpCodeInt32(0xFE, 0x15, 1, 0, token);
            this.PopStackOperands(VESType.NativeInt | VESType.ManagedPointer);
        }
        ...
        public override void NewArray(Type type)
        {
            ...
            int token = this.GetToken(type);
            this.Emit1ByteOpCodeInt32(0x8D, 1, 1, token);
            this.PopStackOperands(VESType.Int32);
            this.PushStackOperand(VESType.Object);
        }
        ...
        public override void LoadArrayElement(Type type)
        {
            ...
            {
                case TypeCode.SByte:
                    this.Emit1ByteOpCode(0x90, 2, 1);
                    break;
                case TypeCode.Int16:
                    this.Emit1ByteOpCode(0x92, 2, 1);
                    break;
                case TypeCode.Int32:
                    this.Emit1ByteOpCode(0x94, 2, 1);
                    break;
                case TypeCode.Int64:
                    this.Emit1ByteOpCode(0x96, 2, 1);
                    break;
                case TypeCode.Byte:
                    this.Emit1ByteOpCode(0x91, 2, 1);
                    break;
                case TypeCode.UInt16:
                    this.Emit1ByteOpCode(0x93, 2, 1);
                    break;
                case TypeCode.UInt32:
                    this.Emit1ByteOpCode(0x95, 2, 1);
                    break;
                case TypeCode.UInt64:
                    this.Emit1ByteOpCode(0x96, 2, 1);
                    break;
                case TypeCode.Single:
                    this.Emit1ByteOpCode(0x98, 2, 1);
                    break;
                case TypeCode.Double:
                    this.Emit1ByteOpCode(0x99, 2, 1);
                    break;
                default:
                    if (type.IsClass == true) {
                        this.Emit1ByteOpCode(0x9A, 2, 1);
                    } else
                    {
                        int token = this.GetToken(type);
                        this.Emit1ByteOpCodeInt32(0xA3, 2, 1, token);
                    }
                    break;
            }

            this.PopStackOperands(VESType.Object, VESType.Int32);
            this.PushStackOperand(ToVESType(type));
        }
        ...
        public override void StoreArrayElement(Type type)
        {
            ...
            switch (Type.GetTypeCode(type))
            {
                case TypeCode.Byte:
                case TypeCode.SByte:
                    this.Emit1ByteOpCode(0x9C, 3, 0);
                    break;
                case TypeCode.UInt16:
                case TypeCode.Int16:
                    this.Emit1ByteOpCode(0x9D, 3, 0);
                    break;
                case TypeCode.UInt32:
                case TypeCode.Int32:
                    this.Emit1ByteOpCode(0x9E, 3, 0);
                    break;
                case TypeCode.UInt64:
                case TypeCode.Int64:
                    this.Emit1ByteOpCode(0x9F, 3, 0);
                    break;
                case TypeCode.Single:
                    this.Emit1ByteOpCode(0xA0, 3, 0);
                    break;
                case TypeCode.Double:
                    this.Emit1ByteOpCode(0xA1, 3, 0);
                    break;
                default:
                    if (type.IsClass == true) {
                        this.Emit1ByteOpCode(0xA2, 3, 0);
                    } else
                    {
                        int token = this.GetToken(type);
                        this.Emit1ByteOpCodeInt32(0xA4, 3, 0, token);
                    }
                    break;
            }
            this.PopStackOperands(VESType.Object, VESType.Int32, ToVESType(type));
        }
        ...
        public override void BeginExceptionBlock()
        {
            ...
            ExceptionRegion region = new ExceptionRegion();
        ...
        public override void EndExceptionBlock()
        {
            ...
            ExceptionRegion exceptionRegion = this.activeExceptionRegions.Pop();
            ...
            this.EndCurrentClause(exceptionRegion);
        ...
        public override void BeginCatchBlock(Type exceptionType)
        {
            ...
            int exceptionTypeToken = this.GetToken(exceptionType);

            // Get the top-most exception region.
            ExceptionRegion exceptionRegion = this.activeExceptionRegions.Peek();
            ...
            this.ReplaceEvaluationStack(VESType.Object);
        }

        /// <summary>
        /// Begins a finally block.  BeginTryCatchFinallyBlock() must have already been called.
        /// </summary>
        public override void BeginFinallyBlock() => this.BeginExceptionBlock(ExceptionClauseType.Finally);

        /// <summary>
        /// Begins a filter block.  BeginTryCatchFinallyBlock() must have already been called.
        /// </summary>
        public override void BeginFilterBlock() => this.BeginExceptionBlock(ExceptionClauseType.Filter);

        /// <summary>
        /// Begins a fault block.  BeginTryCatchFinallyBlock() must have already been called.
        /// </summary>
        public override void BeginFaultBlock() => this.BeginExceptionBlock(ExceptionClauseType.Fault);
        ...
        public override void EndFilter()
        {
            ...
            ExceptionClause latestClause = exceptionRegion.Clauses[exceptionRegion.Clauses.Count - 1];
            if (latestClause.Type != ExceptionClauseType.Filter) {
                throw new InvalidOperationException("EndFilter can only be called from within an exception filter.");
            }

            this.Emit2ByteOpCode(0xFE, 0x11, 1, 0);
            this.PopStackOperands(VESType.Int32);
        ...
        private void EndCurrentClause(ExceptionRegion exceptionRegion)
        {
            ...
            {
                // End the try block.
                this.Leave(exceptionRegion.EndLabel);
        ...
        /// </summary>
        public override void Breakpoint() => this.Emit1ByteOpCode(0x01, 0, 0);
        ...
        /// Does nothing.
        /// </summary>
        public override void NoOperation() => this.Emit1ByteOpCode(0x00, 0, 0);
