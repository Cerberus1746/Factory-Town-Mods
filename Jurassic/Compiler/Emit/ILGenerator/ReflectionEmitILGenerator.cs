...
namespace Jurassic.Compiler
{
    ...
    internal class ReflectionEmitILGenerator : ILGenerator
    {
        ...
        /// </summary>
        public override void Complete() => this.Return();
        ...
        /// </summary>
        public override void Pop() => this.generator.Emit(OpCodes.Pop);

        /// <summary>
        /// Duplicates the value on the top of the stack.
        /// </summary>
        public override void Duplicate() => this.generator.Emit(OpCodes.Dup);
        ...
        public override ILLabel CreateLabel() => new ReflectionEmitILLabel(this.generator.DefineLabel());
        ...
        /// return value.
        /// </summary>
        public override void Return() => this.generator.Emit(OpCodes.Ret);
        ...
        public override void Switch(ILLabel[] labels)
        {
            ...
            System.Reflection.Emit.Label[] reflectionLabels = new System.Reflection.Emit.Label[labels.Length];
        ...
        public override ILLocalVariable DeclareVariable(Type type, string name = null) => new ReflectionEmitILLocalVariable(this.generator.DeclareLocal(type), name);
        ...
        /// </summary>
        public override void LoadNull() => this.generator.Emit(OpCodes.Ldnull);
        ...
        public override void LoadInt64(long value) => this.generator.Emit(OpCodes.Ldc_I8, value);

        /// <summary>
        /// Pushes a constant value onto the stack.
        /// </summary>
        /// <param name="value"> The number to push onto the stack. </param>
        public override void LoadDouble(double value) => this.generator.Emit(OpCodes.Ldc_R8, value);

        /// <summary>
        /// Pushes a constant value onto the stack.
        /// </summary>
        /// <param name="value"> The string to push onto the stack. </param>
        public override void LoadString(string value) => this.generator.Emit(OpCodes.Ldstr, value);
        ...
        /// </summary>
        public override void CompareEqual() => this.generator.Emit(OpCodes.Ceq);
        ...
        /// of the arguments are <c>NaN</c>.
        /// </summary>
        public override void CompareGreaterThan() => this.generator.Emit(OpCodes.Cgt);
        ...
        /// </summary>
        public override void CompareGreaterThanUnsigned() => this.generator.Emit(OpCodes.Cgt_Un);
        ...
        /// of the arguments are <c>NaN</c>.
        /// </summary>
        public override void CompareLessThan() => this.generator.Emit(OpCodes.Clt);
        ...
        /// of the arguments are <c>NaN</c>.  Integers are considered to be unsigned.
        /// </summary>
        public override void CompareLessThanUnsigned() => this.generator.Emit(OpCodes.Clt_Un);
        ...
        /// </summary>
        public override void ShiftRight() => this.generator.Emit(OpCodes.Shr);

        /// <summary>
        /// Pops two values from the stack, shifts the first to the right, then pushes the result
        /// to the stack.  The sign bit is not preserved.
        /// </summary>
        public override void ShiftRightUnsigned() => this.generator.Emit(OpCodes.Shr_Un);
        ...
        /// the stack.
        /// </summary>
        public override void ConvertToInteger() => this.generator.Emit(OpCodes.Conv_I4);

        /// <summary>
        /// Pops a value from the stack, converts it to an unsigned integer, then pushes it back
        /// onto the stack.
        /// </summary>
        public override void ConvertToUnsignedInteger() => this.generator.Emit(OpCodes.Conv_U4);

        /// <summary>
        /// Pops a value from the stack, converts it to a signed 64-bit integer, then pushes it
        /// back onto the stack.
        /// </summary>
        public override void ConvertToInt64() => this.generator.Emit(OpCodes.Conv_I8);

        /// <summary>
        /// Pops a value from the stack, converts it to an unsigned 64-bit integer, then pushes it
        /// back onto the stack.
        /// </summary>
        public override void ConvertToUnsignedInt64() => this.generator.Emit(OpCodes.Conv_U8);

        /// <summary>
        /// Pops a value from the stack, converts it to a double, then pushes it back onto
        /// the stack.
        /// </summary>
        public override void ConvertToDouble() => this.generator.Emit(OpCodes.Conv_R8);

        /// <summary>
        /// Pops an unsigned integer from the stack, converts it to a double, then pushes it back onto
        /// the stack.
        /// </summary>
        public override void ConvertUnsignedToDouble() => this.generator.Emit(OpCodes.Conv_R_Un);
        ...
        public override void NewObject(System.Reflection.ConstructorInfo constructor) => this.generator.Emit(OpCodes.Newobj, constructor);
        ...
        public override void CastClass(Type type) => this.generator.Emit(OpCodes.Castclass, type);
        ...
        /// <param name="type"> The type of the class the object inherits from or the interface the
        /// object implements. </param>
        public override void IsInstance(Type type) => this.generator.Emit(OpCodes.Isinst, type);
        ...
        public override void LoadToken(Type type) => this.generator.Emit(OpCodes.Ldtoken, type);
        ...
        public override void LoadToken(System.Reflection.FieldInfo field) => this.generator.Emit(OpCodes.Ldtoken, field);
        ...
        public override void NewArray(Type type) => this.generator.Emit(OpCodes.Newarr, type);
        ...
        /// </summary>
        public override void LoadArrayLength() => this.generator.Emit(OpCodes.Ldlen);
        ...
        /// </summary>
        public override void Throw() => this.generator.Emit(OpCodes.Throw);
        ...
        /// </summary>
        public override void BeginExceptionBlock() => this.generator.BeginExceptionBlock();

        /// <summary>
        /// Ends a try-catch-finally block.  BeginExceptionBlock() must have already been called.
        /// </summary>
        public override void EndExceptionBlock() => this.generator.EndExceptionBlock();
        ...
        public override void BeginCatchBlock(Type exceptionType) => this.generator.BeginCatchBlock(exceptionType);

        /// <summary>
        /// Begins a finally block.  BeginExceptionBlock() must have already been called.
        /// </summary>
        public override void BeginFinallyBlock() => this.generator.BeginFinallyBlock();

        /// <summary>
        /// Begins a filter block.  BeginExceptionBlock() must have already been called.
        /// </summary>
        public override void BeginFilterBlock() => this.generator.BeginExceptFilterBlock();

        /// <summary>
        /// Begins a fault block.  BeginExceptionBlock() must have already been called.
        /// </summary>
        public override void BeginFaultBlock() => this.generator.BeginFaultBlock();
        ...
        /// </summary>
        public override void EndFinally() => this.generator.Emit(OpCodes.Endfinally);
        ...
        /// </summary>
        public override void EndFilter() => this.generator.Emit(OpCodes.Endfilter);
        ...
        /// </summary>
        public override void Breakpoint() => this.generator.Emit(OpCodes.Break);
        ...
        /// Does nothing.
        /// </summary>
        public override void NoOperation() => this.generator.Emit(OpCodes.Nop);
    }
