...
namespace Jurassic.Compiler
{
    ...
    internal static class EmitHelpers
    {
        ...
        public static void EmitUndefined(ILGenerator generator) => generator.LoadField(ReflectionHelpers.Undefined_Value);

        /// <summary>
        /// Emits null.
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void EmitNull(ILGenerator generator) => generator.LoadField(ReflectionHelpers.Null_Value);
        ...
        {
            ILLocalVariable temp = generator.CreateTemporaryVariable(type);
        ...
        /// <param name="generator"> The IL generator. </param>
        /// <param name="type"> The type of value to generate. </param>
        public static void EmitDefaultValue(ILGenerator generator, PrimitiveType type) => EmitDefaultValue(generator, PrimitiveTypeUtilities.ToType(type));
        ...
        public static void EmitThrow(ILGenerator generator, string name, string message) => EmitThrow(generator, name, message, null, null, 0);
        ...
        public static void EmitThrow(ILGenerator generator, string name, string message, OptimizationInfo optimizationInfo) => EmitThrow(generator, name, message, optimizationInfo.Source.Path, optimizationInfo.FunctionName, optimizationInfo.SourceSpan.StartLine);
        ...
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void LoadScriptEngine(ILGenerator generator) => generator.LoadArgument(0);

        /// <summary>
        /// Pushes a reference to the current scope onto the stack.
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void LoadScope(ILGenerator generator) => generator.LoadArgument(1);

        /// <summary>
        /// Stores the reference on top of the stack as the new scope.
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void StoreScope(ILGenerator generator) => generator.StoreArgument(1);

        /// <summary>
        /// Pushes the value of the <c>this</c> keyword onto the stack.
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void LoadThis(ILGenerator generator) => generator.LoadArgument(2);

        /// <summary>
        /// Stores the reference on top of the stack as the new value of the <c>this</c> keyword.
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void StoreThis(ILGenerator generator) => generator.StoreArgument(2);

        /// <summary>
        /// Pushes a reference to the current function onto the stack.
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void LoadFunction(ILGenerator generator) => generator.LoadArgument(3);
        ...
        /// </summary>
        /// <param name="generator"> The IL generator. </param>
        public static void LoadArgumentsArray(ILGenerator generator) => generator.LoadArgument(4);
    }
