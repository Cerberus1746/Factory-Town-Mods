...
namespace Jurassic.Compiler
{
    ...
    internal class JSBinderMethod : BinderMethod
    {
        ...
        {
            // Restore the flags.
            JSFunctionFlags flags = (JSFunctionFlags)info.GetInt32("flags");
        ...
        protected override ParameterInfo[] GetParameters()
        {
            ...
            ParameterInfo[] result = base.GetParameters();
        ...
        public override IEnumerable<BinderArgument> GetArguments(int argumentCount)
        {
            ...
            foreach (BinderArgument arg in base.GetArguments(argumentCount)) {
                yield return arg;
            }
        }
    }
