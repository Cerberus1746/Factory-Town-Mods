...
namespace Jurassic.Compiler
{
    ...
    internal class ClrBinder : MethodBinder
    {
        ...
        protected override void GenerateStub(ILGenerator generator, int argumentCount)
        {
            ...
            List<BinderMethod> candidateMethods = new List<BinderMethod>();
            foreach (BinderMethod candidateMethod in this.targetMethods)
            {
            ...
            ILLabel endOfMethod = generator.CreateLabel();
            for (int i = 0; i < candidateMethods.Count; i++)
            {
                ...
                BinderMethod targetMethod = candidateMethods[i];

                // Convert the arguments.
                foreach (BinderArgument argument in targetMethod.GenerateArguments(generator, argumentCount))
                {
        ...
        internal static void EmitConversionToType(ILGenerator generator, Type toType, bool convertToAddress)
        {
            ...
            {
                ILLabel startOfElse = generator.CreateLabel();
            ...
            switch (Type.GetTypeCode(toType))
            {
                ...
                case TypeCode.Char:
                    ...
                    ILLabel endOfCharCheck = generator.CreateLabel();
                ...
                case TypeCode.Object:
                    ...
                    ILLabel endOfUnwrapCheck = generator.CreateLabel();
