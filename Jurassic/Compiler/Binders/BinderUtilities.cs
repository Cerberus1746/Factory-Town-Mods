...
namespace Jurassic.Compiler
{
    ...
    public static class BinderUtilities
    {
        ...
        public static int ResolveOverloads(RuntimeMethodHandle[] methodHandles, ScriptEngine engine, object thisValue, object[] arguments)
        {
            ...
            BinderMethod[] methods = new BinderMethod[methodHandles.Length];
            ...
            {
                foreach (BinderArgument argument in methods[i].GetArguments(arguments.Length))
                {
            ...
            {
                List<BinderMethod> ambiguousMethods = new List<BinderMethod>(lowestIndices.Count);
