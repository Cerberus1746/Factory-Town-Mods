...
namespace Jurassic.Compiler
{
...
#endif
    {
        ...
        protected BinderMethod(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
        {
            ...
            string typeName = info.GetString("methodType");
            ...
            MethodAttributes attributes = (MethodAttributes)info.GetInt32("methodAttributes");
            ...
            string[] argumentTypeNames = (string[])info.GetValue("methodArgumentTypes", typeof(string[]));
            Type[] argumentTypes = new Type[argumentTypeNames.Length];
        ...
        public virtual void GetObjectData(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
        {
            ...
            string[] argumentTypeNames = new string[parameters.Length];
            for (int i = 0; i < parameters.Length; i++) {
        ...
        protected virtual ParameterInfo[] GetParameters() => this.Method.GetParameters();
        ...
        {
            if (this.IsArgumentCountCompatible(argumentCount) == false) {
        ...
        public IEnumerable<BinderArgument> GenerateArguments(ILGenerator generator, int argumentCount)
        {
            ...
            foreach (BinderArgument argument in this.GetArguments(argumentCount))
            {
            ...
            if (this.RequiredParameterCount + this.OptionalParameterCount - argumentCount > 0)
            {
                ...
                {
                    ParameterInfo optionalParameter = parameters[argumentCount + i];
    ...
    internal class BinderArgument
    {
        ...
        public object DefaultValue
        {
            get
            {
                ...
                DefaultParameterValueAttribute attribute = this.GetCustomAttribute<DefaultParameterValueAttribute>();
                if (attribute == null) {
