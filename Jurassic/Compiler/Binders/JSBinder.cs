    ...
    internal class JSBinder : MethodBinder
    {
            ...
            : base(targetMethods.Select(m => (BinderMethod)m))
        {
            ...
            for (int argumentCount = 0; argumentCount < this.buckets.Length; argumentCount++)
            {
                ...
                foreach (JSBinderMethod method in targetMethods)
                {
        ...
        protected override void GenerateStub(ILGenerator generator, int argumentCount)
        {
            ...
            JSBinderMethod binderMethod = this.buckets[Math.Min(argumentCount, this.buckets.Length - 1)];
            ...
            foreach (BinderArgument argument in binderMethod.GenerateArguments(generator, Math.Min(Math.Max(argumentCount, minArgumentCount), maxArgumentCount)))
            {
                switch (argument.Source)
                {
                    ...
                    case BinderArgumentSource.ThisValue:
                        ...
                        else
                        {
                            ...
                            if (argument.Type != typeof(ObjectInstance) && inheritsFromObjectInstance == true)
                            {
                                ...
                                // not generic.
                                ILLabel endOfThrowLabel = generator.CreateLabel();
                                generator.Duplicate();
                    ...
                    case BinderArgumentSource.InputParameter:
                        if (argument.InputParameterIndex < argumentCount)
                        {
                            ...
                            JSParameterFlags parameterFlags = JSParameterFlags.None;
                            JSParameterAttribute parameterAttribute = argument.GetCustomAttribute<JSParameterAttribute>();
            ...
            } else
            {
                ...
                ILLabel endOfSpecialCaseLabel = generator.CreateLabel();
                generator.Duplicate();
