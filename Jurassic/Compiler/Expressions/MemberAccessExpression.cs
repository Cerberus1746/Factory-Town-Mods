...
namespace Jurassic.Compiler
{
    ...
    internal sealed class MemberAccessExpression : OperatorExpression, IReferenceExpression
    {
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            this.GenerateReference(generator, optimizationInfo);
            this.GenerateGet(generator, optimizationInfo, false);
        }
        ...
        private TypeOfMemberAccess DetermineTypeOfMemberAccess(OptimizationInfo optimizationInfo, out string propertyName)
        {
            ...
            {
                NameExpression rhs = this.GetOperand(1) as NameExpression;
                if (rhs == null) {
            ...
            {
                LiteralExpression rhs = this.GetOperand(1) as LiteralExpression;
        ...
        public void GenerateReference(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            TypeOfMemberAccess memberAccessType = this.DetermineTypeOfMemberAccess(optimizationInfo, out propertyName);
            ...
            if (memberAccessType == TypeOfMemberAccess.ArrayIndex)
            {
                ...
                Expression lhs = this.GetOperand(0);
        ...
        public void DuplicateReference(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            {
                // Array indexer
                ILLocalVariable arg1 = generator.CreateTemporaryVariable(typeof(object));
                ILLocalVariable arg2 = generator.CreateTemporaryVariable(typeof(uint));
            ...
            else
            {
                // Dynamic property access
                ILLocalVariable arg1 = generator.CreateTemporaryVariable(typeof(object));
                ILLocalVariable arg2 = generator.CreateTemporaryVariable(typeof(object));
                generator.StoreVariable(arg2);
                generator.StoreVariable(arg1);
                generator.LoadVariable(arg1);
                generator.LoadVariable(arg2);
        ...
        public void GenerateGet(ILGenerator generator, OptimizationInfo optimizationInfo, bool throwIfUnresolvable)
        {
            ...
            else if (memberAccessType == TypeOfMemberAccess.Static)
            {
                ...
                ILLocalVariable cacheKey = generator.DeclareVariable(typeof(object));
                ILLocalVariable cachedIndex = generator.DeclareVariable(typeof(int));

                // Store the object into a temp variable.
                ILLocalVariable objectInstance = generator.DeclareVariable(PrimitiveType.Object);
        ...
        public void GenerateSet(ILGenerator generator, OptimizationInfo optimizationInfo, PrimitiveType valueType, bool throwIfUnresolvable)
        {
            ...
            else if (memberAccessType == TypeOfMemberAccess.Static)
            {
                ...
                ILLocalVariable value = generator.CreateTemporaryVariable(typeof(object));
                EmitConversion.ToAny(generator, valueType);
