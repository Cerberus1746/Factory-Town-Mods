...
namespace Jurassic.Compiler
{
    ...
    internal class AssignmentExpression : OperatorExpression
    {
        ...
        public override PrimitiveType ResultType
        {
            get
            {
                OperatorType type = this.OperatorType;
                ...
                BinaryExpression compoundOperator = new BinaryExpression(GetCompoundBaseOperator(type), this.GetOperand(0), this.GetOperand(1));
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            IReferenceExpression target = this.GetOperand(0) as IReferenceExpression;
            if (target == null)
            {
            ...
            switch (this.OperatorType)
            {
                case OperatorType.Assignment:
                    ...
                    this.GenerateAssignment(generator, optimizationInfo, target);
                    break;

                case OperatorType.PostIncrement:
                    this.GenerateIncrementOrDecrement(generator, optimizationInfo, target, postfix: true, increment: true);
                    break;
                case OperatorType.PostDecrement:
                    this.GenerateIncrementOrDecrement(generator, optimizationInfo, target, postfix: true, increment: false);
                    break;
                case OperatorType.PreIncrement:
                    this.GenerateIncrementOrDecrement(generator, optimizationInfo, target, postfix: false, increment: true);
                    break;
                case OperatorType.PreDecrement:
                    this.GenerateIncrementOrDecrement(generator, optimizationInfo, target, postfix: false, increment: false);
                    break;

                case OperatorType.CompoundAdd:
                    // Special case +=
                    this.GenerateCompoundAddAssignment(generator, optimizationInfo, target);
                    break;

                default:
                    // All other compound operators.
                    this.GenerateCompoundAssignment(generator, optimizationInfo, target);
                    break;
            }
        }
        ...
        private void GenerateAssignment(ILGenerator generator, OptimizationInfo optimizationInfo, IReferenceExpression target)
        {
            ...
            ILLocalVariable result = generator.CreateTemporaryVariable(rhs.ResultType);
            generator.Duplicate();
        ...
        private void GenerateIncrementOrDecrement(ILGenerator generator, OptimizationInfo optimizationInfo, IReferenceExpression target, bool postfix, bool increment)
        {
            ...
            ILLocalVariable result = generator.CreateTemporaryVariable(target.Type == PrimitiveType.Int32 ? PrimitiveType.Int32 : PrimitiveType.Number);
            if (postfix == true)
            {
                generator.Duplicate();
                generator.StoreVariable(result);
        ...
        private void GenerateCompoundAssignment(ILGenerator generator, OptimizationInfo optimizationInfo, IReferenceExpression target)
        {
            ...
            // Load the value to assign.
            BinaryExpression compoundOperator = new BinaryExpression(GetCompoundBaseOperator(this.OperatorType), new ReferenceGetExpression(target), this.GetOperand(1));
            ...
            ILLocalVariable result = generator.CreateTemporaryVariable(compoundOperator.ResultType);
            generator.Duplicate();
            generator.StoreVariable(result);
