...
namespace Jurassic.Compiler
{
    ...
    internal class FunctionCallExpression : OperatorExpression
    {
        ...
        private class TemporaryVariableExpression : Expression
        {
            ...
            public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo) => generator.LoadVariable(this.variable);
        }
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            {
                this.GenerateEval(generator, optimizationInfo);
                return;
            }
            ...
            if (this.Target is MemberAccessExpression)
            {
                ...
                Expression baseExpression = ((MemberAccessExpression)this.Target).Base;
                ...
                MemberAccessExpression memberAccessExpression = new MemberAccessExpression(((MemberAccessExpression)this.Target).Operator);
            ...
            this.GenerateArgumentsArray(generator, optimizationInfo);
        ...
        internal void GenerateArgumentsArray(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            else
            {
                ...
                Expression argumentsOperand = this.GetRawOperand(1);
