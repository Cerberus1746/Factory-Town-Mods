...
namespace Jurassic.Compiler
{
    ...
    internal sealed class TernaryExpression : OperatorExpression
    {
        ...
        public override object Evaluate()
        {
            ...
            object condition = this.GetOperand(0).Evaluate();
            if (condition == null) {
                return null;
            }

            object result1 = this.GetOperand(1).Evaluate();
            if (result1 == null) {
                return null;
            }

            object result2 = this.GetOperand(2).Evaluate();
            if (result2 == null) {
                return null;
            }
        ...
        public override PrimitiveType ResultType
        {
            get
            {
                ...
                PrimitiveType a = this.GetOperand(1).ResultType;
                PrimitiveType b = this.GetOperand(2).ResultType;
                if (a == b) {
                    return a;
                }
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            // Emit the condition.
            Expression condition = this.GetOperand(0);
            ...
            PrimitiveType outputType = this.ResultType;
