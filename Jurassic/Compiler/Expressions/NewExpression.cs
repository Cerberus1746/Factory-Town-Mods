...
namespace Jurassic.Compiler
{
    ...
    internal sealed class NewExpression : OperatorExpression
    {
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            Expression operand = this.GetRawOperand(0);
            ...
            if (operand is FunctionCallExpression)
            {
                ...
                Expression function = ((FunctionCallExpression)operand).Target;
            ...
            ILLocalVariable targetValue = generator.CreateTemporaryVariable(typeof(object));
