...
namespace Jurassic.Compiler
{
    ...
    internal sealed class GroupingExpression : OperatorExpression
    {
        ...
        public override object Evaluate()
        {
            ...
            object operand = this.GetOperand(0).Evaluate();
            if (operand == null) {
                return null;
            }
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo) => this.Operand.GenerateCode(generator, optimizationInfo);
    }
