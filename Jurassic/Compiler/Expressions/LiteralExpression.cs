...
namespace Jurassic.Compiler
{
    ...
    internal sealed class LiteralExpression : Expression
    {
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            {
                // RegExp
                ILLocalVariable sharedRegExpVariable = optimizationInfo.GetRegExpVariable(generator, (RegularExpressionLiteral)this.Value);
                ILLabel label1 = generator.CreateLabel();
                ILLabel label2 = generator.CreateLabel();
            ...
            else if (this.Value is List<Expression>)
            {
                ...
                List<Expression> arrayLiteral = (List<Expression>)this.Value;
                ...
                for (int i = 0; i < arrayLiteral.Count; i ++)
                {
                    ...
                    // Value
                    Expression elementExpression = arrayLiteral[i];
            ...
            else if (this.Value is Dictionary<string, object>)
            {
                ...
                Dictionary<string, object> properties = (Dictionary<string, object>)this.Value;
                ...
                foreach (KeyValuePair<string, object> keyValuePair in properties)
                {
                    ...
                    if (propertyValue is Expression)
                    {
                        ...
                        Expression dataPropertyValue = (Expression)propertyValue;
                    ...
                    else if (propertyValue is Parser.ObjectLiteralAccessor)
                    {
                        ...
                        Parser.ObjectLiteralAccessor accessorValue = (Parser.ObjectLiteralAccessor)propertyValue;
        ...
        public override string ToString()
        {
            ...
            if (this.Value is List<Expression>)
            {
                ...
                foreach (Expression item in (List<Expression>)this.Value)
                {
                    if (result.Length > 1) {
                        result.Append(", ");
                    }
            ...
            {
                System.Text.StringBuilder result = new System.Text.StringBuilder("{");
                foreach (KeyValuePair<string, object> keyValuePair in (Dictionary<string, object>)this.Value)
                {
                    if (result.Length > 1) {
                        result.Append(", ");
                    }
                    ...
                    {
                        Parser.ObjectLiteralAccessor accessor = (Parser.ObjectLiteralAccessor)keyValuePair.Value;
