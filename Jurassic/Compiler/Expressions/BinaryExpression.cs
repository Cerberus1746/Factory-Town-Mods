...
namespace Jurassic.Compiler
{
    ...
    internal class BinaryExpression : OperatorExpression
    {
        ...
        public override object Evaluate()
        {
            ...
            switch (this.OperatorType)
            {
                case OperatorType.Add:
                    {
                    object leftPrimitive = TypeConverter.ToPrimitive(left, PrimitiveTypeHint.None);
                    object rightPrimitive = TypeConverter.ToPrimitive(right, PrimitiveTypeHint.None);
        ...
        public override PrimitiveType ResultType
        {
            get
            {
                ...
                switch (this.OperatorType)
                {
                    ...
                    case OperatorType.Add:
                        {
                        PrimitiveType lhs = this.Left.ResultType;
                        PrimitiveType rhs = this.Right.ResultType;
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            {
                this.GenerateAdd(generator, optimizationInfo);
                return;
            }
            ...
            {
                this.GenerateInstanceOf(generator, optimizationInfo);
                return;
            }
            ...
            {
                this.GenerateIn(generator, optimizationInfo);
                return;
            }
            ...
            {
                this.GenerateRelational(generator, optimizationInfo);
                return;
            }
            ...
            {
                this.GenerateLogical(generator, optimizationInfo);
                return;
            }
        ...
        private void GenerateInstanceOf(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            generator.Duplicate();
            ILLabel endOfTypeCheck = generator.CreateLabel();
            generator.BranchIfNotNull(endOfTypeCheck);

            // Throw an nicely formatted exception.
            ILLocalVariable rightValue = generator.CreateTemporaryVariable(typeof(object));
        ...
        private void GenerateIn(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            // Store the left-hand side expression in a temporary variable.
            ILLocalVariable temp = generator.CreateTemporaryVariable(typeof(string));
            generator.StoreVariable(temp);
