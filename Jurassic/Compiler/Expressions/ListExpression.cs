...
namespace Jurassic.Compiler
{
    ...
    internal class ListExpression : OperatorExpression
    {
        ...
        public override object Evaluate()
        {
            ...
            object left = this.GetRawOperand(0).Evaluate();
            if (left == null) {
                return null;
            }

            object right = this.GetRawOperand(1).Evaluate();
            if (right == null) {
                return null;
            }
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            IList<Expression> items = this.Items;
        ...
        public override string ToString() => string.Format("{0}, {1}", this.GetOperand(0), this.GetOperand(1));
    }
