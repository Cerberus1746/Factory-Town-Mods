...
namespace Jurassic.Compiler
{
    ...
    internal class GlobalMethodGenerator : MethodGenerator
    {
        ...
        protected override string GetMethodName()
        {
            ...
            // underscores.
            System.Text.StringBuilder sanitizedPath = new System.Text.StringBuilder(this.Source.Path);
        ...
        public override void Parse()
        {
            ...
            {
                Parser parser = new Parser(this.Engine, lexer, this.InitialScope, this.Options, CodeContext.Global);
