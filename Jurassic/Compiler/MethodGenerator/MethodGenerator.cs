...
namespace Jurassic.Compiler
{
    ...
    internal abstract class MethodGenerator
    {
        ...
        protected virtual string GetStackName() => null;
        ...
        protected virtual Type[] GetParameterTypes() => new Type[] {
        ...
        public void GenerateCode()
        {
            ...
            OptimizationInfo optimizationInfo = new OptimizationInfo(this.Engine);
            ...
            if (this.Options.EnableDebugging == false)
            {
                ...
                if (ScriptEngine.LowPrivilegeEnvironment == false)
                {
                    ...
                    dynamicMethod = new System.Reflection.Emit.DynamicMethod(
                        this.GetMethodName(),                                        // Name of the generated method.
                        typeof(object),                                         // Return type of the generated method.
                        this.GetParameterTypes(),                                    // Parameter types of the generated method.
                    ...
                    generator = Environment.Version.Major >= 4 && !ScriptEngine.IsMonoRuntime
                        ? new DynamicILGenerator(dynamicMethod)
                        : (ILGenerator) new ReflectionEmitILGenerator(dynamicMethod.GetILGenerator());
                }
                else
                {
#endif
                ...
                // Generate the IL.
                this.GenerateCode(generator, optimizationInfo);
                generator.Complete();

                // Create a delegate from the method.
                this.GeneratedMethod = new GeneratedMethod(dynamicMethod.CreateDelegate(this.GetDelegate()), optimizationInfo.NestedFunctions);
            ...
            else
            {
                ...
                if (reflectionEmitInfo == null)
                {
                    ...
                    System.Reflection.ConstructorInfo debuggableAttributeConstructor = typeof(System.Diagnostics.DebuggableAttribute).GetConstructor(
                ...
                System.Reflection.Emit.TypeBuilder typeBuilder = reflectionEmitInfo.ModuleBuilder.DefineType("JavaScriptClass" + reflectionEmitInfo.TypeCount.ToString(), System.Reflection.TypeAttributes.Public | System.Reflection.TypeAttributes.Class);
                reflectionEmitInfo.TypeCount++;

                // Create a method.
                System.Reflection.Emit.MethodBuilder methodBuilder = typeBuilder.DefineMethod(this.GetMethodName(),
                    ...
                    typeof(object), this.GetParameterTypes());
                ...
                System.Reflection.MethodInfo methodInfo = type.GetMethod(this.GetMethodName());
                this.GeneratedMethod = new GeneratedMethod(Delegate.CreateDelegate(this.GetDelegate(), methodInfo), optimizationInfo.NestedFunctions);
#endif //WINDOWS_PHONE
            }
        ...
        protected virtual Type GetDelegate() => typeof(Func<ScriptEngine, Scope, object, object>);
    }
