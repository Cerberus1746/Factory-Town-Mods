...
namespace Jurassic.Compiler
{
    ...
    internal class FunctionMethodGenerator : MethodGenerator
    {
        ...
        private class DummyScriptSource : ScriptSource
        {
            ...
            public override System.IO.TextReader GetReader() => throw new NotImplementedException();
        }
        ...
        protected override string GetStackName() => this.GetMethodName();
        ...
        protected override Type[] GetParameterTypes() => new Type[] {
        ...
        private void Validate()
        {
            if (this.StrictMode == true)
            {
                ...
                foreach (string argumentName in this.ArgumentNames) {
        ...
        public override void Parse()
        {
            ...
            {
                using (Lexer lexer = new Lexer(this.Engine, this.Source))
                {
                    Parser parser = new Parser(this.Engine, lexer, this.InitialScope, this.Options, CodeContext.Function);
        ...
        protected override Type GetDelegate() => typeof(Library.FunctionDelegate);
        ...
        protected override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            if (this.StrictMode == false && this.MethodOptimizationHints.HasThis == true)
            {
                ...
                // {
                ILLabel startOfFalse = generator.CreateLabel();
                ...
                optimizationInfo.MethodOptimizationHints.HasVariable(this.Name))
            {
                ...
                NameExpression functionName = new NameExpression(this.InitialScope, this.Name);
            ...
            if (this.MethodOptimizationHints.HasArguments == true && this.ArgumentNames.Contains("arguments") == false)
            {
                ...
                NameExpression arguments = new NameExpression(this.InitialScope, "arguments");
            ...
            {
                ILLabel endOfArguments = generator.CreateLabel();
                for (int i = 0; i < this.ArgumentNames.Count; i++)
                {
                    ...
                    NameExpression argument = new NameExpression(this.InitialScope, this.ArgumentNames[i]);
