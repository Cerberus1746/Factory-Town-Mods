    ...
    public class GeneratedMethod
    {
        ...
        public static GeneratedMethod Load(long id)
        {
            lock (cacheLock)
            {
                ...
                GeneratedMethod generatedMethod = (GeneratedMethod)generatedMethodReference.Target;
        ...
        public static long Save(GeneratedMethod generatedMethod)
        {
            ...
            lock (cacheLock)
            {
                ...
                WeakReference weakReference = new WeakReference(generatedMethod);
                ...
                if (generatedMethodID % compactGeneratedCacheCount == 0)
                {
                    ...
                    List<long> expiredIDs = new List<long>();
                    foreach (KeyValuePair<long, WeakReference> pair in generatedMethodCache) {
