...
namespace Jurassic.Compiler
{
    ...
    internal class EvalMethodGenerator : MethodGenerator
    {
        ...
        protected override string GetMethodName() => "eval";
        ...
        public override void Parse()
        {
            ...
            {
                Parser parser = new Parser(this.Engine, lexer, this.InitialScope, this.Options, CodeContext.Eval);
