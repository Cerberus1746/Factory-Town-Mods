...
namespace Jurassic.Compiler
{
    ...
    internal sealed class Parser
    {
        ...
        {
            Parser result = (Parser)parser.MemberwiseClone();
        ...
        private bool AtValidEndOfStatement() =>
            ...
            this.nextToken == PunctuatorToken.Semicolon ||
        ...
        public Statement Parse()
        {
            ...
            BlockStatement result = new BlockStatement(new string[0]);
            while (true)
            {
                ...
                StringLiteralToken directiveToken = this.nextToken as StringLiteralToken;
                ...
                SourceCodePosition beforeInitialToken = this.PositionAfterWhitespace;
                Expression expression = this.ParseExpression(PunctuatorToken.Semicolon);

                // The statement must be added to the AST so that eval("'test'") works.
                ExpressionStatement initialStatement = new ExpressionStatement(this.labelsForCurrentStatement, expression);
            ...
            while (true)
            {
                ...
                result.Statements.Add(this.ParseStatement());
            }
        ...
        private Statement ParseStatement()
        {
            ...
            // Parse the statement.
            Statement statement = this.ParseStatementNoNewContext();
        ...
        private Statement ParseStatementNoNewContext()
        {
            ...
            return this.ParseLabelOrExpressionStatement();
        }
        ...
        private BlockStatement ParseBlock()
        {
            ...
            BlockStatement result = new BlockStatement(this.labelsForCurrentStatement);
            while (true)
            {
        ...
        {
            VarStatement result = new VarStatement(this.labelsForCurrentStatement, this.currentScope);
            ...
            while (true)
            {
                ...
                this.ValidateVariableName(declaration.VariableName);
                ...
                if (this.nextToken == PunctuatorToken.Assignment)
                {
                    ...
                    declaration.InitExpression = this.ParseExpression(PunctuatorToken.Semicolon, PunctuatorToken.Comma);
        ...
        {
            EmptyStatement result = new EmptyStatement(this.labelsForCurrentStatement);
        ...
        {
            IfStatement result = new IfStatement(this.labelsForCurrentStatement);
            ...
            // Parse the condition.
            result.Condition = this.ParseExpression(PunctuatorToken.RightParenthesis);
            ...
            result.IfClause = this.ParseStatement();
            ...
            if (this.nextToken == KeywordToken.Else)
            {
                ...
                result.ElseClause = this.ParseStatement();
            }
        ...
        {
            DoWhileStatement result = new DoWhileStatement(this.labelsForCurrentStatement);
            ...
            // Parse the condition.
            start = this.PositionAfterWhitespace;
            result.ConditionStatement = new ExpressionStatement(this.ParseExpression(PunctuatorToken.RightParenthesis));
        ...
        {
            WhileStatement result = new WhileStatement(this.labelsForCurrentStatement);
        ...
        private Statement ParseFor()
        {
            ...
            if (this.nextToken == KeywordToken.Var)
            {
                ...
                VarStatement varStatement = new VarStatement(this.labelsForCurrentStatement, this.currentScope);
            ...
            else
            {
                ...
                {
                    // Parse an expression.
                    Expression initializationExpression = this.ParseExpression(PunctuatorToken.Semicolon, KeywordToken.In);
            ...
            if (forInReference != null)
            {
                // for (x in y)
                // for (var x in y)
                ForInStatement result = new ForInStatement(this.labelsForCurrentStatement);
                ...
                start = this.PositionAfterWhitespace;
                result.TargetObject = this.ParseExpression(PunctuatorToken.RightParenthesis);
            ...
            {
                ForStatement result = new ForStatement(this.labelsForCurrentStatement);
                ...
                {
                    start = this.PositionAfterWhitespace;
                    result.ConditionStatement = new ExpressionStatement(this.ParseExpression(PunctuatorToken.Semicolon));
                    result.ConditionStatement.SourceSpan = new SourceCodeSpan(start, this.PositionBeforeWhitespace);
                }
                ...
                {
                    start = this.PositionAfterWhitespace;
                    result.IncrementStatement = new ExpressionStatement(this.ParseExpression(PunctuatorToken.RightParenthesis));
        ...
        {
            ContinueStatement result = new ContinueStatement(this.labelsForCurrentStatement);
        ...
        {
            BreakStatement result = new BreakStatement(this.labelsForCurrentStatement);
        ...
        private ReturnStatement ParseReturn()
        {
            ...
            ReturnStatement result = new ReturnStatement(this.labelsForCurrentStatement);
            ...
            if (this.AtValidEndOfStatement() == false)
            {
                ...
                result.Value = this.ParseExpression(PunctuatorToken.Semicolon);
            }
        ...
        private WithStatement ParseWith()
        {
            ...
            WithStatement result = new WithStatement(this.labelsForCurrentStatement);
            ...
            Expression objectEnvironment = this.ParseExpression(PunctuatorToken.RightParenthesis);
        ...
        {
            SwitchStatement result = new SwitchStatement(this.labelsForCurrentStatement);
            ...
            result.Value = this.ParseExpression(PunctuatorToken.RightParenthesis);
            ...
            while (true)
            {
                ...
                {
                    SwitchCase caseClause = new SwitchCase();

                    // Read the case keyword.
                    this.Expect(KeywordToken.Case);

                    // Parse the case expression.
                    caseClause.Value = this.ParseExpression(PunctuatorToken.Colon);
                    ...
                    while (this.nextToken != KeywordToken.Case && this.nextToken != KeywordToken.Default && this.nextToken != PunctuatorToken.RightBrace) {
                        caseClause.BodyStatements.Add(this.ParseStatement());
                    }
                ...
                else if (this.nextToken == KeywordToken.Default)
                {
                    ...
                    // Zero or more statements can be added to the case statement.
                    while (this.nextToken != KeywordToken.Case && this.nextToken != KeywordToken.Default && this.nextToken != PunctuatorToken.RightBrace) {
                        defaultClause.BodyStatements.Add(this.ParseStatement());
                    }
        ...
        {
            ThrowStatement result = new ThrowStatement(this.labelsForCurrentStatement);
        ...
        {
            TryCatchFinallyStatement result = new TryCatchFinallyStatement(this.labelsForCurrentStatement);

            // Consume the try keyword.
            this.Expect(KeywordToken.Try);

            // Parse the try block.
            result.TryBlock = this.ParseBlock();
            ...
            if (this.nextToken == KeywordToken.Catch)
            {
                ...
                result.CatchBlock = this.ParseBlock();
            ...
            if (this.nextToken == KeywordToken.Finally)
            {
                ...
                result.FinallyBlock = this.ParseBlock();
            }
        ...
        {
            DebuggerStatement result = new DebuggerStatement(this.labelsForCurrentStatement);
        ...
        private Statement ParseFunctionDeclaration()
        {
            ...
            FunctionExpression expression = this.ParseFunction(FunctionType.Declaration, this.initialScope);
        ...
        private FunctionExpression ParseFunction(FunctionType functionType, Scope parentScope)
        {
            ...
            else if (functionType == FunctionType.Getter || functionType == FunctionType.Setter)
            {
                ...
                bool wasIdentifier;
                functionName = this.ReadPropertyName(out wasIdentifier);
            }
            else {
                throw new ArgumentOutOfRangeException("functionType");
            }

            this.ValidateVariableName(functionName);
            ...
            if (this.nextToken != PunctuatorToken.RightParenthesis)
            {
                ...
                this.ValidateVariableName(argumentName);
            ...
            SourceCodePosition startPosition = this.PositionBeforeWhitespace;

            // Since the parser reads one token in advance, start capturing the function body here.
            System.Text.StringBuilder bodyTextBuilder = new System.Text.StringBuilder();
            System.Text.StringBuilder originalBodyTextBuilder = this.lexer.InputCaptureStringBuilder;
            ...
            Parser functionParser = Parser.CreateFunctionBodyParser(this, scope);
            Statement body = functionParser.Parse();
            ...
            CompilerOptions options = this.options.Clone();
        ...
        private Statement ParseLabelOrExpressionStatement()
        {
            ...
            Expression expression = this.ParseExpression(PunctuatorToken.Semicolon, PunctuatorToken.Colon);
            ...
            if (this.nextToken == PunctuatorToken.Colon && expression is NameExpression)
            {
                ...
                string labelName = ((NameExpression)expression).Name;
                ...
                return this.ParseStatementNoNewContext();
            }
            else
            {
                ...
                ExpressionStatement result = new ExpressionStatement(this.labelsForCurrentStatement, expression);
        ...
        private struct OperatorKey
        {
            ...
            public override int GetHashCode() => this.Token.GetHashCode() ^ this.PostfixOrInfix.GetHashCode();
        }
        ...
        {
            Dictionary<OperatorKey, Operator> result = new Dictionary<OperatorKey, Operator>(55);
            foreach (Operator @operator in Operator.AllOperators)
            {
        ...
        private static Operator OperatorFromToken(Token token, bool postfixOrInfix)
        {
            ...
            if (operatorLookup == null)
            {
                ...
                Dictionary<OperatorKey, Operator> temp = InitializeOperatorLookup();
        ...
        private Expression ParseExpression(params Token[] endTokens)
        {
            ...
            while (this.nextToken != null)
            {
                    ...
                    (this.nextToken is KeywordToken && unboundOperator != null && unboundOperator.OperatorType == OperatorType.MemberAccess && this.expressionState == ParserExpressionState.Literal))
                {
                    ...
                    } else if (this.nextToken is IdentifierToken)
                    {
                        ...
                        string identifierName = ((IdentifierToken)this.nextToken).Name;
                    ...
                    else if (this.nextToken == KeywordToken.This)
                    {
                        ...
                        // Array literal.
                        terminal = this.ParseArrayLiteral();
                    } else if (this.nextToken == PunctuatorToken.LeftBrace) {
                        // Object literal.
                        terminal = this.ParseObjectLiteral();
                    } else if (this.nextToken == KeywordToken.Function) {
                        terminal = this.ParseFunctionExpression();
                    } else {
                ...
                else if (this.nextToken is PunctuatorToken || this.nextToken is KeywordToken)
                {
                    ...
                    if (this.nextToken == newOperator.SecondaryToken)
                    {
                        ...
                        OperatorExpression node = root as OperatorExpression;
                        while (node != null)
                        {
                    ...
                    else
                    {
                        ...
                        OperatorExpression newExpression = OperatorExpression.FromOperator(newOperator);
            ...
            this.CheckASTValidity(root);

            // A literal is the next valid expression token.
            this.expressionState = ParserExpressionState.Literal;
            this.lexer.ParserExpressionState = this.expressionState;
        ...
        private void CheckASTValidity(Expression root)
        {
            ...
            while (stack.Count > 0)
            {
                ...
                OperatorExpression expression = stack.Pop() as OperatorExpression;
        ...
        private LiteralExpression ParseArrayLiteral()
        {
            ...
            while (true)
            {
                ...
                if (this.nextToken == PunctuatorToken.Comma) {
                    ...
                    items.Add(this.ParseExpression(PunctuatorToken.Comma, PunctuatorToken.RightBracket));
                }
        ...
        private LiteralExpression ParseObjectLiteral()
        {
            ...
            while (true)
            {
                ...
                string propertyName = this.ReadPropertyName(out mightBeGetOrSet);
                ...
                if (this.nextToken != PunctuatorToken.Colon && mightBeGetOrSet == true && (propertyName == "get" || propertyName == "set"))
                {
                    ...
                    FunctionExpression function = this.ParseFunction(propertyName == "get" ? FunctionType.Getter : FunctionType.Setter, this.currentScope);

                    // Get the function name.
                    string getOrSet = propertyName;
                    ...
                    if (getOrSet == "get")
                    {
                        ...
                        } else
                        {
                            ...
                            ObjectLiteralAccessor existingAccessor = existingValue as ObjectLiteralAccessor;
                ...
                else
                {
                    ...
                    propertyValue = this.ParseExpression(PunctuatorToken.Comma, PunctuatorToken.RightBrace);
        ...
        /// </summary>
        /// <returns> A function expression. </returns>
        private FunctionExpression ParseFunctionExpression() => this.ParseFunction(FunctionType.Expression, this.currentScope);
    }
