...
namespace Jurassic.Compiler
{
    ...
    public abstract class Scope
    {
        ...
        internal IEnumerable<string> DeclaredVariableNames
        {
            get
            {
                List<DeclaredVariable> declaredVariables = new List<DeclaredVariable>(this.variables.Values);
                declaredVariables.Sort((a, b) => a.Index - b.Index);
                string[] names = new string[declaredVariables.Count];
        ...
        internal bool HasDeclaredVariable(string name) => this.variables.ContainsKey(name);
        ...
        /// </summary>
        /// <param name="name"> The name of the variable. </param>
        internal void RemovedDeclaredVariable(string name) => this.variables.Remove(name);
        ...
        internal virtual void GenerateDeclarations(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            foreach (DeclaredVariable variable in this.variables.Values)
            {
                ...
                if (variable.ValueAtTopOfScope != null)
                {
                    ...
                    if (this is ObjectScope)
                    {
                        ...
                        Library.PropertyAttributes attributes = Library.PropertyAttributes.Enumerable;
                    ...
                    {
                        variable.ValueAtTopOfScope.GenerateCode(generator, optimizationInfo);
                        NameExpression name = new NameExpression(this, variable.Name);
