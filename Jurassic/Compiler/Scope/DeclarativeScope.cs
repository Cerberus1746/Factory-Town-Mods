...
namespace Jurassic.Compiler
{
    ...
    public class DeclarativeScope : Scope
    {
        ...
        public static DeclarativeScope CreateRuntimeScope(Scope parentScope, string[] declaredVariableNames)
        {
            ...
            DeclarativeScope result = new DeclarativeScope(parentScope, declaredVariableNames.Length);
        ...
        /// otherwise. </returns>
        public override bool HasValue(string variableName) => this.HasDeclaredVariable(variableName);
        ...
        public override object GetValue(string variableName)
        {
            ...
            DeclaredVariable variable = this.GetDeclaredVariable(variableName);
            if (variable == null) {
                return null;
            }
        ...
        public override bool Delete(string variableName)
        {
            ...
            // from the scope.
            this.RemovedDeclaredVariable(variableName);
            return true;
        }
        ...
        internal override void GenerateScopeCreation(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            else
            {
                ...
                foreach (DeclaredVariable variable in this.DeclaredVariables)
                {
                    variable.Store = null;
