    ...
    internal class TryCatchFinallyStatement : Statement
    {
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            if (this.CatchBlock != null)
            {
                ...
                NameExpression catchVariable = new NameExpression(this.CatchScope, this.CatchVariableName);
            ...
            if (this.FinallyBlock != null)
            {
                ...
                List<ILLabel> branches = new List<ILLabel>();
                int previousStackSize = optimizationInfo.LongJumpStackSizeThreshold;
                optimizationInfo.LongJumpStackSizeThreshold = optimizationInfo.BreakOrContinueStackSize;
                Action<ILGenerator, ILLabel> previousCallback = optimizationInfo.LongJumpCallback;
