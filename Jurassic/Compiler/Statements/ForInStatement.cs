...
namespace Jurassic.Compiler
{
    ...
    internal class ForInStatement : Statement
    {
        ...
        public override void GenerateCode(ILGenerator generator, OptimizationInfo optimizationInfo)
        {
            ...
            ILLocalVariable enumerator = generator.CreateTemporaryVariable(typeof(IEnumerator<string>));
            generator.StoreVariable(enumerator);

            ILLabel breakTarget = generator.CreateLabel();
            ILLabel continueTarget = generator.DefineLabelPosition();
        ...
        public override IEnumerable<AstNode> ChildNodes
        {
            get
            {
                ...
                AssignmentExpression fakeAssignment = new AssignmentExpression(Operator.Assignment);
