...
namespace Jurassic.Library
{
    ...
    internal class StandardConsoleOutput : IFirebugConsoleOutput
    {
        ...
        {
            this.Log(FirebugConsoleMessageStyle.Regular, new object[] { title });
        ...
        /// </summary>
        public void EndGroup() => this.CurrentIndentation = Math.Max(this.CurrentIndentation - this.IndentationDelta, 0);
    }
}
