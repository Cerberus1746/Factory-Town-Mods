...
namespace Jurassic.Library
{
    ...
    public class ArrayConstructor : ClrFunction
    {
        ...
        /// </summary>
        public ArrayInstance New() => new ArrayInstance(this.InstancePrototype, 0, 10);
        ...
        /// <param name="elements"> The initial elements of the new array. </param>
        [JSCallFunction]
        public ArrayInstance Call(params object[] elements) => this.Construct(elements);
        ...
        public static bool IsArray(object value) => value is ArrayInstance;
