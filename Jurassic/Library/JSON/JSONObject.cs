...
namespace Jurassic.Library
{
    ...
    public class JSONObject : ObjectInstance
    {
        ...
        {
            JSONParser parser = new JSONParser(engine, new JSONLexer(engine, new System.IO.StringReader(text)));
        ...
        {
            JSONSerializer serializer = new JSONSerializer(engine);
            ...
            {
                ArrayInstance replacerArray = (ArrayInstance)replacer;
                HashSet<string> serializableProperties = new HashSet<string>(StringComparer.Ordinal);
