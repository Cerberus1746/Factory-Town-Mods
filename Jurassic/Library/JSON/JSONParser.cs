...
namespace Jurassic.Library
{
    ...
    internal sealed class JSONParser
    {
        ...
        private ArrayInstance ParseArrayLiteral()
        {
            ...
            ArrayInstance result = this.engine.Array.New();
            uint arrayIndex = 0;
            while (this.nextToken != PunctuatorToken.RightBracket)
            {
                ...
                object elementValue = this.ParseValue();
                ...
                if (this.ReviverFunction != null)
                {
                    object transformedValue = this.ReviverFunction.CallFromNative("parse", result, arrayIndex.ToString(), elementValue);
        ...
        private ObjectInstance ParseObjectLiteral()
        {
            ...
            while (this.nextToken != PunctuatorToken.RightBrace)
            {
                ...
                object propertyValue = this.ParseValue();
                ...
                if (this.ReviverFunction != null)
                {
                    object transformedValue = this.ReviverFunction.CallFromNative("parse", result, propertyName, propertyValue);
