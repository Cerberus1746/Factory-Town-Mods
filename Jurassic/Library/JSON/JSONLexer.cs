...
namespace Jurassic.Library
{
    ...
    internal sealed class JSONLexer
    {
        ...
        public Token NextToken()
        {
            ...
            {
                // Reserved word.
                return this.ReadKeyword(c);
            }
            else if (c == '\"')
            {
                // String literal.
                return this.ReadStringLiteral(c);
            }
            else if (this.IsNumericLiteralStartChar(c) == true)
            {
                // Number literal.
                return this.ReadNumericLiteral(c);
            }
            else
            {
                switch (c)
                ...
                if (c == '\\')
                {
                    ...
                    switch (c)
                    {
                        ...
                        case 'u':
                            ...
                            contents.Append(this.ReadHexNumber(4));
                            break;
                        default:
        ...
        /// otherwise. </returns>
        private static bool IsWhiteSpace(int c) => c == 0x09 || c == 0x0A || c == 0x0D || c == 0x20;
        ...
        private static bool IsIdentifierChar(int c) => c >= 'a' && c <= 'z';
        ...
        private bool IsNumericLiteralStartChar(int c) => (c >= '0' && c <= '9') || c == '-';
