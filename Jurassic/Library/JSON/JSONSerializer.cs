...
namespace Jurassic.Library
{
    ...
    internal sealed class JSONSerializer
    {
        ...
        public string Serialize(object value)
        {
            ...
            ObjectInstance tempObject = this.engine.Object.Construct();
            tempObject[string.Empty] = value;

            // Transform the value.
            value = this.TransformPropertyValue(tempObject, string.Empty);
            ...
            this.SerializePropertyValue(value, result);
        ...
        private void SerializePropertyValue(object value, StringBuilder result)
        {
            ...
            {
                this.SerializeArray((ArrayInstance)value, result);
                return;
            }
            ...
            {
                this.SerializeObject((ObjectInstance)value, result);
                return;
            }
        ...
        private void SerializeObject(ObjectInstance value, StringBuilder result)
        {
            ...
            ICollection<string> propertiesToSerialize = this.SerializableProperties;
            if (propertiesToSerialize == null)
            {
                propertiesToSerialize = new List<string>();
                foreach (PropertyNameAndValue property in value.Properties) {
            ...
            foreach (string propertyName in propertiesToSerialize)
            {
                ...
                object propertyValue = this.TransformPropertyValue(value, propertyName);
                ...
                this.SerializePropertyValue(propertyValue, result);
        ...
        private void SerializeArray(ArrayInstance value, StringBuilder result)
        {
            ...
            for (uint i = 0; i < value.Length; i++)
            {
                ...
                // Transform the value using the replacer function or toJSON().
                object elementValue = this.TransformPropertyValue(value, i);
                ...
                else
                {
                    ...
                    this.SerializePropertyValue(elementValue, result);
                }
            }
            if (value.Length > 0) {
                result.Append(previousSeparator);
