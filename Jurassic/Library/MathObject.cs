...
namespace Jurassic.Library
{
    ...
    public class MathObject : ObjectInstance
    {
        ...
        public static double Acos(double number) => System.Math.Acos(number);
        ...
        public static double Asin(double number) => System.Math.Asin(number);
        ...
        public static double Atan(double number) => System.Math.Atan(number);
        ...
        public static double Ceil(double number) => System.Math.Ceiling(number);
        ...
        public static double Exp(double number) => System.Math.Exp(number);
        ...
        public static double Floor(double number) => System.Math.Floor(number);
        ...
        public static double Log(double number) => System.Math.Log(number);
