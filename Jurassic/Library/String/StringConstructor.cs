...
namespace Jurassic.Library
{
    ...
    public class StringConstructor : ClrFunction
    {
        ...
        public StringInstance Construct() => new StringInstance(this.InstancePrototype);
        ...
        [JSConstructorFunction]
        public StringInstance Construct(string value) => new StringInstance(this.InstancePrototype, value);
        ...
        public static string FromCharCode(params double[] charCodes)
        {
            ...
            System.Text.StringBuilder result = new System.Text.StringBuilder(charCodes.Length);
