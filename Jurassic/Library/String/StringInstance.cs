...
namespace Jurassic.Library
{
    ...
    public class StringInstance : ObjectInstance
    {
        ...
        public override PropertyDescriptor GetOwnPropertyDescriptor(uint index)
        {
            ...
            {
                string result = this.value[(int)index].ToString();
        ...
        public override IEnumerable<PropertyNameAndValue> Properties
        {
            get
            {
                ...
                foreach (PropertyNameAndValue nameAndValue in base.Properties) {
        ...
        public static ConcatenatedString Concat(ScriptEngine engine, object thisObject, params object[] strings)
        {
            ...
            else
            {
                ...
                string thisObject2 = TypeConverter.ToString(thisObject);

                // Append the strings together.
                ConcatenatedString result = new ConcatenatedString(thisObject2);
        ...
        public static int LocaleCompare(string thisObject, string str) => string.Compare(thisObject, str);
        ...
        {
            System.Text.StringBuilder result = new System.Text.StringBuilder(thisObject.Length + 2);
            result.Append('"');
        ...
        public static string Replace(string thisObject, string substr, string replaceText)
        {
            ...
            System.Text.StringBuilder result = new System.Text.StringBuilder(thisObject.Length + (replaceText.Length - substr.Length));
        ...
        public static string Replace(string thisObject, string substr, FunctionInstance replaceFunction)
        {
            ...
            string replaceText = TypeConverter.ToString(replaceFunction.CallFromNative("replace", null, substr, start, thisObject));
        ...
        public static string Replace(string thisObject, RegExpInstance regExp, string replaceText) => regExp.Replace(thisObject, replaceText);
        ...
        /// for every successful match. </param>
        /// <returns> A copy of this string with text replaced using a regular expression. </returns>
        public static string Replace(string thisObject, RegExpInstance regExp, FunctionInstance replaceFunction) => regExp.Replace(thisObject, replaceFunction);
        ...
        /// <param name="limit"> The maximum number of array items to return.  Defaults to unlimited. </param>
        /// <returns> An array containing the split strings. </returns>
        public static ArrayInstance Split(string thisObject, RegExpInstance regExp, [DefaultParameterValue(uint.MaxValue)] uint limit = uint.MaxValue) => regExp.Split(thisObject, limit);
        ...
        public static ArrayInstance Split(ScriptEngine engine, string thisObject, string separator, [DefaultParameterValue(uint.MaxValue)] uint limit = uint.MaxValue)
        {
            ...
            string[] splitStrings = thisObject.Split(new string[] { separator }, StringSplitOptions.None);
            if (limit < splitStrings.Length)
            {
                string[] splitStrings2 = new string[limit];
        ...
        public static string Substring(string thisObject, int start, [DefaultParameterValue(int.MaxValue)] int end = int.MaxValue) => Slice(thisObject, Math.Max(Math.Min(start, end), 0), Math.Max(Math.Max(start, end), 0));
        ...
        public static string ToLocaleLowerCase(string thisObject) => thisObject.ToLower();
        ...
        public static string ToLocaleUpperCase(string thisObject) => thisObject.ToUpper();
        ...
        public static string ToLowerCase(string thisObject) => thisObject.ToLowerInvariant();
        ...
        public static string ToUpperCase(string thisObject) => thisObject.ToUpperInvariant();
        ...
        public static string Trim(string thisObject) => thisObject.Trim(trimCharacters);
        ...
        public static string TrimLeft(string thisObject) => thisObject.TrimStart(trimCharacters);
        ...
        public static string TrimRight(string thisObject) => thisObject.TrimEnd(trimCharacters);
        ...
        public new string ValueOf() => this.value;
        ...
        public static string Anchor(string thisObject, string name) => string.Format(@"<a name=""{1}"">{0}</a>", thisObject, name);
        ...
        public static string Big(string thisObject) => string.Format("<big>{0}</big>", thisObject);
        ...
        public static string Blink(string thisObject) => string.Format("<blink>{0}</blink>", thisObject);
        ...
        public static string Bold(string thisObject) => string.Format("<b>{0}</b>", thisObject);
        ...
        public static string Fixed(string thisObject) => string.Format("<tt>{0}</tt>", thisObject);
        ...
        public static string FontColor(string thisObject, string colorValue) => string.Format(@"<font color=""{1}"">{0}</font>", thisObject, colorValue);
        ...
        public static string FontSize(string thisObject, string size) => string.Format(@"<font size=""{1}"">{0}</font>", thisObject, size);
        ...
        public static string Italics(string thisObject) => string.Format("<i>{0}</i>", thisObject);
        ...
        public static string Link(string thisObject, string href) => string.Format(@"<a href=""{1}"">{0}</a>", thisObject, href);
        ...
        public static string Small(string thisObject) => string.Format("<small>{0}</small>", thisObject);
        ...
        public static string Strike(string thisObject) => string.Format("<strike>{0}</strike>", thisObject);
        ...
        public static string Sub(string thisObject) => string.Format("<sub>{0}</sub>", thisObject);
        ...
        public static string Sup(string thisObject) => string.Format("<sup>{0}</sup>", thisObject);
    }
}
