...
namespace Jurassic.Library
{
    ...
    public class RegExpConstructor : ClrFunction
    {
        ...
        private void InitializeDeprecatedProperties()
        {
            ...
            this.InitializeDeprecatedProperty("$1", this.GetGroup1, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$2", this.GetGroup2, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$3", this.GetGroup3, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$4", this.GetGroup4, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$5", this.GetGroup5, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$6", this.GetGroup6, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$7", this.GetGroup7, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$8", this.GetGroup8, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$9", this.GetGroup9, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("input", this.GetInput, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$_", this.GetInput, PropertyAttributes.Sealed);
            this.InitializeDeprecatedProperty("lastMatch", this.GetLastMatch, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$&", this.GetLastMatch, PropertyAttributes.Sealed);
            this.InitializeDeprecatedProperty("lastParen", this.GetLastParen, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$+", this.GetLastParen, PropertyAttributes.Sealed);
            this.InitializeDeprecatedProperty("leftContext", this.GetLeftContext, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$`", this.GetLeftContext, PropertyAttributes.Sealed);
            this.InitializeDeprecatedProperty("rightContext", this.GetRightContext, PropertyAttributes.Enumerable);
            this.InitializeDeprecatedProperty("$'", this.GetRightContext, PropertyAttributes.Sealed);
        }
        ...
        private void InitializeDeprecatedProperty(string propertyName, Func<string> getter, PropertyAttributes attributes) => this.DefineProperty(propertyName, new PropertyDescriptor(new PropertyAccessorValue(new ClrFunction(this.Engine.Function.InstancePrototype, getter), null), attributes), false);
