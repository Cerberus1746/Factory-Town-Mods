...
namespace Jurassic.Library
{
    ...
    public class ErrorConstructor : ClrFunction
    {
        ...
        [JSCallFunction]
        public ErrorInstance Call([DefaultParameterValue("")] string message = "") => new ErrorInstance(this.InstancePrototype, null, message);
        ...
        public ErrorInstance Construct([DefaultParameterValue("")] string message = "") => new ErrorInstance(this.InstancePrototype, null, message);
