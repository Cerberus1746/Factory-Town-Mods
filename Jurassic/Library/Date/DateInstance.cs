...
namespace Jurassic.Library
{
    ...
    public class DateInstance : ObjectInstance
    {
        ...
        public double GetFullYear() => this.GetDateComponent(DateComponent.Year, DateTimeKind.Local);
        ...
        public double GetYear() => this.GetDateComponent(DateComponent.Year, DateTimeKind.Local) - 1900;
        ...
        public double GetMonth() => this.GetDateComponent(DateComponent.Month, DateTimeKind.Local);
        ...
        public double GetDate() => this.GetDateComponent(DateComponent.Day, DateTimeKind.Local);
        ...
        public double GetDay() => this.GetDateComponent(DateComponent.DayOfWeek, DateTimeKind.Local);
        ...
        public double GetHours() => this.GetDateComponent(DateComponent.Hour, DateTimeKind.Local);
        ...
        public double GetMinutes() => this.GetDateComponent(DateComponent.Minute, DateTimeKind.Local);
        ...
        public double GetSeconds() => this.GetDateComponent(DateComponent.Second, DateTimeKind.Local);
        ...
        public double GetMilliseconds() => this.GetDateComponent(DateComponent.Millisecond, DateTimeKind.Local);
        ...
        public double GetTime() => this.ValueInMilliseconds;
        ...
        public double GetUTCFullYear() => this.GetDateComponent(DateComponent.Year, DateTimeKind.Utc);
        ...
        public double GetUTCMonth() => this.GetDateComponent(DateComponent.Month, DateTimeKind.Utc);
        ...
        public double GetUTCDate() => this.GetDateComponent(DateComponent.Day, DateTimeKind.Utc);
        ...
        public double GetUTCDay() => this.GetDateComponent(DateComponent.DayOfWeek, DateTimeKind.Utc);
        ...
        public double GetUTCHours() => this.GetDateComponent(DateComponent.Hour, DateTimeKind.Utc);
        ...
        public double GetUTCMinutes() => this.GetDateComponent(DateComponent.Minute, DateTimeKind.Utc);
        ...
        public double GetUTCSeconds() => this.GetDateComponent(DateComponent.Second, DateTimeKind.Utc);
        ...
        public double GetUTCMilliseconds() => this.GetDateComponent(DateComponent.Millisecond, DateTimeKind.Utc);
        ...
        public double SetFullYear(double year) => this.SetDateComponents(DateComponent.Year, DateTimeKind.Local, year);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setFullYear", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetFullYear(double year, double month) => this.SetDateComponents(DateComponent.Year, DateTimeKind.Local, year, month);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setFullYear", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetFullYear(double year, double month, double day) => this.SetDateComponents(DateComponent.Year, DateTimeKind.Local, year, month, day);
        ...
        public double SetYear(double year) => this.SetDateComponents(DateComponent.Year, DateTimeKind.Local, year >= 0 && year < 100 ? year + 1900 : year);
        ...
        public double SetMonth(double month) => this.SetDateComponents(DateComponent.Month, DateTimeKind.Local, month);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setMonth", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetMonth(double month, double day) => this.SetDateComponents(DateComponent.Month, DateTimeKind.Local, month, day);
        ...
        public double SetDate(double day) => this.SetDateComponents(DateComponent.Day, DateTimeKind.Local, day);
        ...
        public double SetHours(double hour) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Local, hour);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setHours", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetHours(double hour, double minute) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Local, hour, minute);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setHours", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetHours(double hour, double minute, double second) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Local, hour, minute, second);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setHours", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetHours(double hour, double minute, double second, double millisecond) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Local, hour, minute, second, millisecond);
        ...
        public double SetMinutes(double minute) => this.SetDateComponents(DateComponent.Minute, DateTimeKind.Local, minute);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setMinutes", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetMinutes(double minute, double second) => this.SetDateComponents(DateComponent.Minute, DateTimeKind.Local, minute, second);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setMinutes", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetMinutes(double minute, double second, double millisecond) => this.SetDateComponents(DateComponent.Minute, DateTimeKind.Local, minute, second, millisecond);
        ...
        public double SetSeconds(double second) => this.SetDateComponents(DateComponent.Second, DateTimeKind.Local, second);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setSeconds", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetSeconds(double second, double millisecond) => this.SetDateComponents(DateComponent.Second, DateTimeKind.Local, second, millisecond);
        ...
        public double SetMilliseconds(double millisecond) => this.SetDateComponents(DateComponent.Millisecond, DateTimeKind.Local, millisecond);
        ...
        public double SetUTCFullYear(double year) => this.SetDateComponents(DateComponent.Year, DateTimeKind.Utc, year);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCFullYear", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCFullYear(double year, double month) => this.SetDateComponents(DateComponent.Year, DateTimeKind.Utc, year, month);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCFullYear", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCFullYear(double year, double month, double day) => this.SetDateComponents(DateComponent.Year, DateTimeKind.Utc, year, month, day);
        ...
        public double SetUTCMonth(double month) => this.SetDateComponents(DateComponent.Month, DateTimeKind.Utc, month);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCMonth", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCMonth(double month, double day) => this.SetDateComponents(DateComponent.Month, DateTimeKind.Utc, month, day);
        ...
        public double SetUTCDate(double day) => this.SetDateComponents(DateComponent.Day, DateTimeKind.Utc, day);
        ...
        public double SetUTCHours(double hour) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Utc, hour);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCHours", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCHours(double hour, double minute) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Utc, hour, minute);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCHours", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCHours(double hour, double minute, double second) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Utc, hour, minute, second);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCHours", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCHours(double hour, double minute, double second, double millisecond) => this.SetDateComponents(DateComponent.Hour, DateTimeKind.Utc, hour, minute, second, millisecond);
        ...
        public double SetUTCMinutes(double minute) => this.SetDateComponents(DateComponent.Minute, DateTimeKind.Utc, minute);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCMinutes", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCMinutes(double minute, double second) => this.SetDateComponents(DateComponent.Minute, DateTimeKind.Utc, minute, second);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCMinutes", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCMinutes(double minute, double second, double millisecond) => this.SetDateComponents(DateComponent.Minute, DateTimeKind.Utc, minute, second, millisecond);
        ...
        public double SetUTCSeconds(double second) => this.SetDateComponents(DateComponent.Second, DateTimeKind.Utc, second);
        ...
        /// the new date. </returns>
        [JSInternalFunction(Name = "setUTCSeconds", Flags = JSFunctionFlags.MutatesThisObject)]
        public double SetUTCSeconds(double second, double millisecond) => this.SetDateComponents(DateComponent.Second, DateTimeKind.Utc, second, millisecond);
        ...
        public double SetUTCMilliseconds(double millisecond) => this.SetDateComponents(DateComponent.Millisecond, DateTimeKind.Utc, millisecond);
        ...
        {
            object number = TypeConverter.ToPrimitive(thisObject, PrimitiveTypeHint.Number);
        ...
        public string ToStringJS()
        {
            ...
            DateTime dateTime = this.value.ToLocalTime();
        ...
        public new double ValueOf() => this.ValueInMilliseconds;
        ...
        public static double Now() => ToJSDate(GetNow());
        ...
        public static double UTC(int year, int month, [DefaultParameterValue(1)] int day = 1, [DefaultParameterValue(0)] int hour = 0,
            [DefaultParameterValue(0)] int minute = 0, [DefaultParameterValue(0)] int second = 0, [DefaultParameterValue(0)] int millisecond = 0) => ToJSDate(ToDateTime(year, month, day, hour, minute, second, millisecond, DateTimeKind.Utc));
        ...
        /// </summary>
        /// <param name="dateStr"> A string representing a date, expressed in RFC 1123 format. </param>
        public static double Parse(string dateStr) => ToJSDate(DateParser.Parse(dateStr));
        ...
        private static string ToTimeZoneString(DateTime dateTime)
        {
            ...
            string zoneName = timeZone.IsDaylightSavingTime(dateTime) ? timeZone.DaylightName : timeZone.StandardName;
            if (hhmm < 0) {
