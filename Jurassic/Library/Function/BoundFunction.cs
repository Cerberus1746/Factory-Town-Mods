...
namespace Jurassic.Library
{
    ...
    internal class BoundFunction : FunctionInstance
    {
            ...
            : base(targetFunction.Prototype)
        {
            ...
            ThrowTypeErrorFunction thrower = new ThrowTypeErrorFunction(this.Engine.Function, "The 'caller' or 'arguments' properties cannot be accessed on a bound function.");
            PropertyAccessorValue accessor = new PropertyAccessorValue(thrower, thrower);
        ...
        /// otherwise. </returns>
        public override bool HasInstance(object instance) => this.TargetFunction.HasInstance(instance);
        ...
        public override object CallLateBound(object thisObject, params object[] argumentValues)
        {
            ...
            object[] resultingArgumentValues = argumentValues;
        ...
        public override string ToString() => this.TargetFunction.ToString();
    }
}
