...
namespace Jurassic.Library
{
    ...
    public class UserDefinedFunction : FunctionInstance
    {
            ...
            : base(prototype)
        {
            ...
            DeclarativeScope scope = DeclarativeScope.CreateFunctionScope(this.Engine.CreateGlobalScope(), name, argumentNames);

            // Compile the code.
            FunctionMethodGenerator context = new FunctionMethodGenerator(this.Engine, scope, name, argumentNames, bodyText, new CompilerOptions());
            context.GenerateCode();

            // Create a new user defined function.
            this.Init(name, argumentNames, this.Engine.CreateGlobalScope(), bodyText, context.GeneratedMethod, context.StrictMode, true);
        }
        ...
        internal UserDefinedFunction(ObjectInstance prototype, string name, IList<string> argumentNames, Scope parentScope, string bodyText, FunctionDelegate body, bool strictMode)
            : base(prototype)
        {
            this.Init(name, argumentNames, parentScope, bodyText, new GeneratedMethod(body, null), strictMode, true);
        }
        ...
        public UserDefinedFunction(ObjectInstance prototype, string name, IList<string> argumentNames, Scope parentScope, string bodyText, GeneratedMethod generatedMethod, bool strictMode)
            : base(prototype)
        {
            this.Init(name, argumentNames, parentScope, bodyText, generatedMethod, strictMode, true);
        }
        ...
        internal static UserDefinedFunction CreateEmptyFunction(ObjectInstance prototype) => new UserDefinedFunction(prototype);
        ...
        private UserDefinedFunction(ObjectInstance prototype)
            : base(prototype)
        {
            FunctionDelegate body = new FunctionDelegate((engine, scope, functionObject, thisObject, argumentValues) => Undefined.Value);
            this.Init("Empty", new string[0], this.Engine.CreateGlobalScope(), "return undefined", new GeneratedMethod(body, null), true, false);
        }
        ...
        private FunctionDelegate Compile()
        {
            if (this.body == null)
            {
                ...
                DeclarativeScope scope = DeclarativeScope.CreateFunctionScope(this.Engine.CreateGlobalScope(), this.Name, this.ArgumentNames);
                FunctionMethodGenerator functionGenerator = new FunctionMethodGenerator(this.Engine, scope, this.Name, this.ArgumentNames, this.BodyText, new CompilerOptions());
        ...
        public string DisassembledIL
        {
            ...
            {
                // Compile the function.
                FunctionDelegate body = this.Compile();
