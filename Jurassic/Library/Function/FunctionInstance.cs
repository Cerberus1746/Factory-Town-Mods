    ...
    public abstract class FunctionInstance : ObjectInstance
    {
        ...
        public ObjectInstance InstancePrototype
        {
            get
            {
                ...
                ObjectInstance prototype = this.cachedInstancePrototypeSchema == this.InlineCacheKey
                    ? this.InlinePropertyValues[this.cachedInstancePrototypeIndex] as ObjectInstance
                    : this.InlineGetPropertyValue("prototype", out this.cachedInstancePrototypeIndex, out this.cachedInstancePrototypeSchema) as ObjectInstance;
        ...
        public string DisplayName
        {
            get
            {
                ...
                string name = TypeConverter.ToString(this["name"]);
        ...
        public virtual bool HasInstance(object instance)
        {
            ...
            ObjectInstance instancePrototype = ((ObjectInstance)instance).Prototype;
        ...
        internal object CallFromNative(string function, object thisObject, params object[] argumentValues)
        {
            ...
            try
            {
                return this.CallLateBound(thisObject, argumentValues);
            }
            finally
            {
        ...
        public virtual ObjectInstance ConstructLateBound(params object[] argumentValues)
        {
            ...
            ObjectInstance newObject = ObjectInstance.CreateRawObject(this.InstancePrototype);

            // Run the function, with the new object as the "this" keyword.
            object result = this.CallLateBound(newObject, argumentValues);
        ...
        public object Call(object thisObj, params object[] arguments) => this.CallLateBound(thisObj, arguments);
        ...
        public FunctionInstance Bind(object boundThis, params object[] boundArguments) => new BoundFunction(this, boundThis, boundArguments);
        ...
        public string ToStringJS() => this.ToString();

        /// <summary>
        /// Returns a string representing this object.
        /// </summary>
        /// <returns> A string representing this object. </returns>
        public override string ToString() => string.Format("function {0}() {{ [native code] }}", this.Name);
    }
}
