...
namespace Jurassic.Library
{
    ...
    internal class ClrStaticTypeWrapper : FunctionInstance
    {
        ...
        public static ClrStaticTypeWrapper FromCache(ScriptEngine engine, Type type)
        {
            ...
            ClrStaticTypeWrapper newInstance = new ClrStaticTypeWrapper(engine, type);
        ...
        public override object CallLateBound(object thisObject, params object[] argumentValues) => throw new JavaScriptException(this.Engine, "TypeError", "CLR types cannot be called like methods");
        ...
        public override ObjectInstance ConstructLateBound(params object[] argumentValues)
        {
            ...
            object result = this.constructBinder.Call(this.Engine, this, argumentValues);
        ...
        internal static void PopulateMembers(ObjectInstance target, Type type, BindingFlags flags)
        {
            ...
            Dictionary<string, List<MethodBase>> methodGroups = new Dictionary<string, List<MethodBase>>();
            foreach (MemberInfo member in type.GetMembers(BindingFlags.Public | BindingFlags.DeclaredOnly | flags))
            {
            ...
            foreach (List<MethodBase> methodGroup in methodGroups.Values)
            {
                ClrBinder binder = new ClrBinder(methodGroup);
                ClrFunction function = new ClrFunction(target.Engine.Function.InstancePrototype, binder);
        ...
        public override string ToString() => this.WrappedType.ToString();
    }
}
