...
namespace Jurassic.Library
{
    ...
    public class NumberConstructor : ClrFunction
    {
        ...
        /// </summary>
        [JSCallFunction]
        public double Call(double value) => value;

        /// <summary>
        /// Creates a new Number instance and initializes it to zero.
        /// </summary>
        [JSConstructorFunction]
        public NumberInstance Construct() => new NumberInstance(this.InstancePrototype, 0);
        ...
        [JSConstructorFunction]
        public NumberInstance Construct(double value) => new NumberInstance(this.InstancePrototype, value);
