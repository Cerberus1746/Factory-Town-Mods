...
namespace Jurassic
{
    ...
    public sealed class ConcatenatedString
    {
        ...
        {
            if (obj is string) {
                return this.Concatenate((string)obj);
            }

            if (obj is ConcatenatedString) {
                return this.Concatenate((ConcatenatedString)obj);
            }

            return this.Concatenate(TypeConverter.ToString(obj));
        }
        ...
        public ConcatenatedString Concatenate(string str)
        {
            ...
            {
                StringBuilder builder = new StringBuilder(this.builder.ToString(0, this.length), this.Length + str.Length);
                builder.Append(str);
        ...
        /// <param name="str"> The string to append. </param>
        /// <returns> A new ConcatenatedString instance representing the concatenated string. </returns>
        public ConcatenatedString Concatenate(ConcatenatedString str) => this.Concatenate(str.ToString());
        ...
        public void Append(object obj)
        {
            if (obj is string) {
                ...
                this.Append((ConcatenatedString)obj);
            } else {
                this.Append(TypeConverter.ToString(obj));
            }
        }
        ...
        /// </summary>
        /// <param name="str"> The string to append. </param>
        public void Append(ConcatenatedString str) => this.Append(str.ToString());
