...
namespace Jurassic
{
    ...
    public static class TypeUtilities
    {
        ...
        internal static bool IsUndefined(object obj) => obj == null || obj == Undefined.Value;
        ...
        /// otherwise. </returns>
        internal static bool IsNumeric(object obj) => obj is double || obj is int || obj is uint;
        ...
        /// otherwise. </returns>
        internal static bool IsString(object obj) => obj is string || obj is ConcatenatedString;
        ...
        internal static object NormalizeValue(object obj)
        {
            ...
            {
                double numericResult = (double)obj;
        ...
        public static IEnumerable<string> EnumeratePropertyNames(ScriptEngine engine, object obj)
        {
            ...
            ObjectInstance obj2 = TypeConverter.ToObject(engine, obj);
            HashSet<string> names = new HashSet<string>();
            do
            {
                foreach (PropertyNameAndValue property in obj2.Properties)
                {
