...
namespace Jurassic
{
    ...
    public static class TypeConverter
    {
        ...
        public static T ConvertTo<T>(ScriptEngine engine, object value) => (T) ConvertTo(engine, value, typeof(T));
        ...
        public static string ToString(object value)
        {
            ...
            if (value is double)
            {
                ...
                NumberToStringCache cache = numberToStringCache;
                if (doubleValue == cache.Value) {
                    return cache.Result;
                }

                // Convert the number to a string.
                string result = NumberFormatter.ToString((double)value, 10, NumberFormatter.Style.Regular);
        ...
        public static ObjectInstance ToObject(ScriptEngine engine, object value) => ToObject(engine, value, 0, null, null);
...
#pragma warning restore 1718
        ...
        public static ushort ToUint16(object value) => (ushort) (uint) ToNumber(value);
