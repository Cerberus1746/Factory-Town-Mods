...
namespace Jurassic
{
    ...
    internal static class NumberFormatter
    {
        ...
        /// </param>
        internal static string ToString(double value, int radix, Style style, int precision = 0) => ToString(value, radix, System.Globalization.CultureInfo.InvariantCulture.NumberFormat, style, precision);
        ...
        internal static string ToString(double value, int radix, System.Globalization.NumberFormatInfo numberFormatInfo, Style style, int precision = 0)
        {
            ...
            DoubleBits bits = new DoubleBits() { DoubleValue = value };
            ...
            int exponent = radix == 10 ? (int)Math.Floor(Math.Log10(value)) : (int)Math.Floor(Math.Log(value, radix));
            ...
            if (errorPowerOfTen != int.MinValue)
            {
                ...
                if (errorPowerOfTen < 0)
                {
                    ...
                    BigInteger errorPowerOfTenMultiplier = BigInteger.Pow(radix, -errorPowerOfTen);
            ...
            for (; digitsOutput < maxDigitsToOutput && rounded == false; digitsOutput++)
            {
                ...
                int digit = (int)BigInteger.Quorem(ref scaledValue, divisor);
        ...
        private static double CalculateError(double value)
        {
            ...
            // Extract the base-2 exponent.
            int base2Exponent = (int)((bits & 0x7FF0000000000000) >> 52);
        ...
        private static BigInteger ScaleToInteger(double value, BigInteger multiplier, int shift)
        {
            ...
            // Extract the base-2 exponent.
            int base2Exponent = (int)((bits & 0x7FF0000000000000) >> 52) - 1023;
