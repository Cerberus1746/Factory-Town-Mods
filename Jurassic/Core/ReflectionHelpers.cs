...
namespace Jurassic
{
    ...
    internal static class ReflectionHelpers
    {
        ...
        static ReflectionHelpers()
        {
            ...
            foreach (ReflectionField reflectionField in GetMembers())
            {
                MethodBase methodBase = reflectionField.MemberInfo as MethodBase;
                ...
                FieldInfo field = reflectionField.MemberInfo as FieldInfo;
        ...
        {
            BindingFlags flags = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly | BindingFlags.ExactBinding;
        ...
        {
            BindingFlags flags = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.DeclaredOnly | BindingFlags.ExactBinding;
            MethodInfo result = type.GetMethod(name, flags, null, parameterTypes, null);
            if (result == null) {
