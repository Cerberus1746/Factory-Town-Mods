...
namespace Jurassic
{
    ...
    internal struct BigInteger
    {
        ...
        {
            int leadingZeroCount = CountLeadingZeroBits(divisor.bits[divisor.wordCount - 1]);
        ...
        public static BigInteger Pow(int radix, int exponent)
        {
            ...
            {
                // Exponent is odd.
                BigInteger temp = Pow(radix, exponent / 2);
        ...
        public static BigInteger Abs(BigInteger b) => new BigInteger(b.bits, b.wordCount, Math.Abs(b.sign));
        ...
        public override string ToString()
        {
            ...
            BigInteger divisor = Pow(10, log10);
        ...
        public double ToDouble()
        {
            ...
            BigInteger temp = BigInteger.RightShift(this, bitCount - 53);
